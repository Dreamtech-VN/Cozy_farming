...
| File trong repo | File gốc trong pack |
| --- | --- |
| `ui/panel-wood.png` | `Containers/Containers/Container1.png` |
| `ui/panel-note.png` | `Containers/Containers/NoteContainerSimple.png` |
| `ui/bar-wood.png` | `Containers/Containers/WoodenContainer1.png` |
| `ui/pill-wood.png` | `Buttons/Round/RoundButton2_wood.png` |
| `ui/pill-cream.png` | `Buttons/Round/RoundButton2_white.png` |
| `ui/round-wood.png` | `Buttons/Round/RoundButton1_wood.png` |
| `ui/btn-wood.png` | `Buttons/Square/SquareButton2_wood.png` |
| `ui/btn-cream.png` | `Buttons/Square/SquareButton2_white.png` |
| `ui/btn-red.png` | `Buttons/Square/SquareButton2_red.png` |
| `ui/slot.png` | `Inventory/ItemSlots/ItemSlotsDefault/ItemSlot1.png` |
...
| `icons/mail.png` | `Icons/IconsDefault/128px/IconsDefault9_128px.png` |
