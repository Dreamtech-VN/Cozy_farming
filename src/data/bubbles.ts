...
export const BUBBLES: BubbleDef[] = [
  ...
  // ---- khung trơn (tĩnh) ----
  { id: 'b_plain_beige', name: 'Kem sữa', price: 800, cur: 'xu', slice: S1 },
  { id: 'b_plain_green', name: 'Cỏ non', price: 800, cur: 'xu', slice: S1 },
  { id: 'b_plain_yellow', name: 'Nắng mai', price: 800, cur: 'xu', slice: S1 },

  // ---- thú cưng & hoa lá (động, mua bằng xu) ----
  { id: 'b_cat', name: 'Mèo nghịch ngợm', price: 3000, cur: 'xu', anim: true, slice: S1 },
  { id: 'b_snowman', name: 'Người tuyết', price: 3000, cur: 'xu', anim: true, slice: S1 },
  ...
  { id: 'b_wood', name: 'Gỗ cổ', price: 60, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_angel', name: 'Thiên thần', price: 60, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_butterfly', name: 'Bướm hồng', price: 80, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_forest', name: 'Rừng xanh', price: 80, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_beach', name: 'Biển hè', price: 100, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_ruby', name: 'Hồng ngọc', price: 120, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_royal', name: 'Hoàng kim', price: 150, cur: 'ruby', anim: true, slice: S1 },
  { id: 'b_blossom', name: 'Hoa xuân', price: 150, cur: 'ruby', anim: true, slice: S1 },

  // ---- hàng hiếm (khung to) ----
  { id: 'b_lotus', name: 'Sen ngọc', price: 200, cur: 'ruby', anim: true, slice: S2 },
  { id: 'b_deer', name: 'Lộc rừng', price: 220, cur: 'ruby', slice: S2 },
  { id: 'b_sword', name: 'Kiếm thần', price: 250, cur: 'ruby', slice: S2 },
  { id: 'b_mountain', name: 'Non nước', price: 280, cur: 'ruby', slice: S2 },
  { id: 'b_aurora', name: 'Cực quang', price: 300, cur: 'ruby', slice: S2 },
  { id: 'b_galaxy', name: 'Ngân hà', price: 350, cur: 'ruby', slice: S2 },
  { id: 'b_phoenix', name: 'Phượng hoàng', price: 400, cur: 'ruby', slice: S2 },
  { id: 'b_meteor', name: 'Sao băng', price: 500, cur: 'ruby', slice: S2 }
];
