...
export const VEHICLES: Record<string, VehicleDef> = {
  ...
  truck_bee: { id: 'truck_bee', name: 'Xe ong chăm chỉ', price: 30000, w: 80, h: 53, desc: 'Vo ve~ xe hiếm phiên bản ong.' },
  camper_green: { id: 'camper_green', name: 'Camper cỏ non', price: 22000, w: 80, h: 50, desc: 'Xanh mát, hợp mấy chuyến về quê.' },
  truck_gift: { id: 'truck_gift', name: 'Xe quà Giáng Sinh', price: 40000, w: 80, h: 56, desc: 'Chở đầy quà và niềm vui.' }
};
