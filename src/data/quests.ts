...
export const TITLES: Record<string, TitleDef> = {
  ...
  ti_smith: { name: 'Thợ Mài', color: '#ced4da', source: 'Khéo Tay', how: 'Nâng cấp công cụ 20 lần.' },
  ti_forge_master: { name: 'Tay Nghề Cứng', color: '#ff6b6b', source: 'Khéo Tay', how: 'Nâng cấp công cụ 100 lần.' },
  ti_starman: { name: 'Được Mùa Được Giá', color: '#ffe066', source: 'Khéo Tay', how: 'Bán 1.000 nông sản.' },
  ti_chest: { name: 'Ăn Khế Trả Vàng', color: '#ffc078', source: 'Khéo Tay', how: 'Rung cây khế 200 lần.' },
