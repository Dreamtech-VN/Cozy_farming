...
class GuildBossAttemptDaoTest {
    private GuildBossAttemptDao dao;

    @BeforeEach
    void setUp() throws SQLException {
        JdbcDataSource ds = new JdbcDataSource();
        ds.setURL("jdbc:h2:mem:guild_boss_attempt_test_" + System.nanoTime() + ";DB_CLOSE_DELAY=-1;MODE=MySQL");
        ...
        this.dao = new GuildBossAttemptDao(dataSource);
    }
