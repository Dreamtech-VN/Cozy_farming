...
writeFileSync(join(OUT, 'city.png'), png);
...
console.log(`city.png     ${ATLAS_W}×${atlasH}  ${(png.length / 1024).toFixed(0)} KB · ${named.length} vật`);
