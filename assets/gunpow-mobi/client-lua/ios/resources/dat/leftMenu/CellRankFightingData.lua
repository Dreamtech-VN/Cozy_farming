...
-------------------------------------公有方法模块Begin--------------------------------------
--@brief    设置节点所需数据
function CellRankFighting:setData(ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, rankType, trendRank, vipLevel, param8, headColor, param9)
    -- body
...
--@brief    初始化cell
function CellRankFighting:initCellData(ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, rankType, trendRank, vipLevel, param8, headColor, param9)
    ...
    if rankType == 1 then   --战力榜
        ...
        GetElement(self.m_root, "imgHead2BK_CellRankFighting", WZUIImage):setFile("ui/common/common_icon_zhanlih.png")
        GetElement(self.m_root, "imgHead2BK_CellRankFighting", WZUIImage):setUseOriginSize(true)
    elseif rankType == 3 then   --宠物榜
        txt10 = "Lv" .. param2
        txt11 = param3
        txt20 = param4
        ...
        txtLevel4:setRelativePosition(GlobalMethod:ccp(0.75, 0.5))
        GetElement(self.m_root, "txtValue4", WZUILabelTTF):setAnchorPoint(GlobalMethod:ccp(0, 1))
        GetElement(self.m_root, "txtValue4", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.75, 0.5))
    ...
    if rankType ~= 3 then
        --人物头像
        self:_showHeadIcon(faceId, headId, sex, "conHead1_CellRankFighting", vipLevel, headColor)
    end
    --获取Container控件
