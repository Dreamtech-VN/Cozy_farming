...
function WndRankList:_setSelSignVisible(bBool, nType)
    -- body
    WZLog("******* WndRankList:_setSelSignVisible ****** ", nType)
...
function WndRankList:_createRankInfoCell(_rankType)
    WZLog("创建排行榜信息Cell",_rankType,self.m_tRankListInfo)
...
function WndRankList:onShowList(element, delta)
    ...
    for i = 1, #infoTable do
        ...
        elseif rankType == 2 or rankType == 13 then
        ...
        --初始化cell
        tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, rankType, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9)
...
function WndRankList:_updateMyRank(_rankType)
    ...
    elseif _rankType == 12 then     --竞技榜
        ...
        imgValueIcon:setRelativePosition(GlobalMethod:ccp(0.5, 0.5))
        ...
        txtProperty:setRelativePosition(GlobalMethod:ccp(0.75, 0.5))
    ...
    GetElement(self.m_root, "txtValueName_WndRankList", WZUILabelTTF):setText(sPropertyWord .. ": ")
