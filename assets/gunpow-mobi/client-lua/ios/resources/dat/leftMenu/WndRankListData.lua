...
function WndRankList:_init()
    ...
    self.m_tTempItemTag = {1,2,3,12,13}
    self.m_tRankListItemTag = {1,2,3,12,13} --8一级标签标志及个数
    self.m_tRankType = {1,2,3,12,13} --9排行榜类型
...
function WndRankList:_setFamousDisplayValue(_rankType)
    ...
    if _rankType == 1 or _rankType == 2 then return end
