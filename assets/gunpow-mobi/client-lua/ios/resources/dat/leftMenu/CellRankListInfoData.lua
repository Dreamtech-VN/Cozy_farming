...
-------------------------------------公有方法模块Begin--------------------------------------
--@brief    设置节点所需数据
function CellRankListInfo:setData(ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, rankType, trendRank, vipLevel, param8, headColor, param9)
    -- body
...
--@brief    初始化cell
function CellRankListInfo:initCellData(ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, rankType, trendRank, vipLevel, param8, headColor, param9)
    ...
    if rankType == 23 then      --恩爱榜
        ...
        --妻子头像
        self:_showHeadIcon(tonumber(param5), tonumber(param4), 1, "conHead2_CellRankListInfo", param8, tonumber(param9))
    end
    if rankType ~= 3 then
        --人物头像
        self:_showHeadIcon(faceId, headId, sex, "conHead1_CellRankListInfo", vipLevel, headColor)
    end
    --获取Container控件
