...
--        GetElement(self.m_root, "playerLevel", WZUILabelTTF):setText(string.format("lv.%d", level))
        ...
        --    imgFightIcon:setRelativePosition(GlobalMethod:ccp(0.7, 0.45))
            ...
            self:_createNameTitle(conInfo, sTempTitle or sTitleString, "Lv" .. tostring(level) .. " " .. tData.name, sIconFilePath, tostring(nPartLevel), "ui/common_num/common_num_yxtbsz.png", GlobalMethod:ccp(0.5, 0.47), bTitleStroke)
...
--            atlasFightLabel:setRelativePosition(GlobalMethod:ccp(0.65, 0.5))
            ...
            txtShowProperty:setStrokeColor(GlobalMethod:ccc3(105,65,46))
...
--            atlasFightLabel:setRelativePosition(GlobalMethod:ccp(0.65, 0.5))
        ...
        --    GetElement(self.m_root, "spineDesi_CellRankSeat", WZUISpine):setRelativePosition(GlobalMethod:ccp(0.55,1.1))
            ...
            imgFightIcon:setVisible(false)
            --师德图标
            self:_createNameTitle(conInfo, sTempTitle or sTitleString, "Lv" .. tostring(level) .. " " .. tData.name, "ui/bag/bag_icon_shitu.png", tostring(tData.valueLv), "ui/common_num/common_num_yxtbsz.png", GlobalMethod:ccp(0.5, 0.5), bTitleStroke)
...
function CellRankSeat:_createNameTitle(parentNode, sTitle, sName, sIconFile, sLvNum, sAtlasFileName, ccpAtlas, bTitleStroke)
    ...
    txtName:setAnchorPoint(GlobalMethod:ccp(0.5, 1))
    txtName:setRelativePosition(GlobalMethod:ccp(0.5, 0.35))
...
function CellRankSeat:setMedalType(nRankIndex, nType)
    ...
    if nRankIndex == 1 then
        imgMedal:setFile("ui/common/common_icon_1st.png")
    elseif nRankIndex == 2 then
        imgMedal:setFile("ui/common/common_icon_2nd.png")
    elseif nRankIndex == 3 then
        imgMedal:setFile("ui/common/common_icon_3rd.png")
    end
end
...
function CellRankSeat:onCheckedPetInfo(element)
    ...
    if petMessage ~= nil and petMessage ~= "" and petMessage ~= "{}" then
        ...
        WndTips:show(conPet,self.m_parentNodeForTips,13,petMessage,GlobalMethod:ccp(200,60))
    end
end
...
function CellRankSeat:setOtherData(_rankType, parentTable, parentNodeForTips)
    ...
    if _rankType == 3 or _rankType == 98 or _rankType == 99 then  --宠物榜
