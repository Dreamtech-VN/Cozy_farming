...
function WndFamilyOperate:_addTop()
    ...
    tNewObj:setTopData("ui/common/common_icon_family.png", SceneFamily, SceneFamily.onClickClose, true, 1, true,nil, {goldType = 11})
...
function WndFamilyOperate:_setNodeVisible()
    ...
    if SceneFamily.m_nPlayerId ~= CacheCenter:getPlayerInfo().id then
        ...
        GetElement(self.m_root, "conBottom_WndFamilyOperate", WZUIContainer):setVisible(false)
