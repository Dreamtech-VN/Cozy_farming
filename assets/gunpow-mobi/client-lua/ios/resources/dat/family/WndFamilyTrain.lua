...
function WndFamilyTrain:_setStaticText()
    ...
    local nState = self:_getTrainState()
    local sFormat = [[<T C="255,255,255" S="22" P="1" SC="79,60,48" SS="4" SE="1">%s</T>]]
    if nState == 0 then
        local sFormatCost = [[<T C="79,60,48" S="18" P="1">%s</T><I Z="0.5" P="1">%s</I><T C="158,0,0" S="18" P="1">x%d</T>]]
...
function WndFamilyTrain:_showLeftSeconds()
    ...
    if ftxtLeftTime then 
        ...
        if self.m_nLeftSeconds > 0 then 
            ...
            ftxtLeftTime:setShowText(string.format([[<T C="255,255,255" S="22" P="1" SC="79,60,48" SS="4" SE="1">%s</T>]], LocalStrings.FAMILY2_TEXT10))
