...
function WndKidServant:setStaticText()
	...
	if ftxtCost then
		local sFormat = [[<T C="255,236,193" S="22" P="1" SC="0,72,3" SS="4" SE="1">%d</T><I Z="0.5">%s</I><T C="255,236,193" S="22" P="1" SC="0,72,3" SS="4" SE="1">%s</T>]]
...
function WndKidServant:_showTime()
	...
	if ftxtLeftTime then
		...
		if self.m_nLeftTime > 0 then
	    	...
	    	local sFormat = [[<T C="99,255,95" S="22" P="1" SC="79,60,48" SS="4" SE="1">%s:</T><T C="99,255,95" S="22" P="1" SC="79,60,48" SS="4" SE="1">%d:%02d:%02d</T>]]
	    	ftxtLeftTime:setShowText(string.format(sFormat, LocalStrings.KID_TEXT18, hours, minutes, seconds))
	    else
	    	self.m_root:disableSchedule()
	    	local sFormat = [[<T C="99,255,95" S="22" P="1" SC="79,60,48" SS="4" SE="1">%s</T>]]
