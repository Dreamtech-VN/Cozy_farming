...
function WndIntoMerry:onCloseClick(element)
    ...
    if SceneWeddingChurch.m_tData.manName == GlobalGame.g_tPlayerInfo.sPlayerName or SceneWeddingChurch.m_tData.womanName == GlobalGame.g_tPlayerInfo.sPlayerName then
