...
function SceneWeddingDaily:SendWedList(weddingHallId, wedStatus, marryType, manName, womanName, startDate, endDate, usePassword, manFaceId, womanFaceId,manId,womanId,womanColour, manColour, womanbodyColour, manbodyColour,womanbodyS,manbodyS,womanHeadS,manHeadS)
	...
	for i,v in ipairs(tempTList) do
		table.insert(tSortIds,1,v)
	end
...
function SceneWeddingDaily:_addTop()
    ...
    tcell:setTopData("ui/common/common_icon_mrhl.png",SceneWeddingDaily,SceneWeddingDaily.onCloseClick,false,true,true,"SceneWeddingDaily")
