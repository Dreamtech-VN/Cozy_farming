...
function CellWeddingItem:_update()
	...
	if self.m_nWeddingStatus == 0 then  
		sStatesImg = "ui/common/marry_icon_zbz.png"
	elseif self.m_nWeddingStatus == 1 then 
		sStatesImg = "ui/common/marry_icon_hlks.png"
	else
		sStatesImg = "ui/common/marry_icon_hlks.png"
	end 
    WZUIImage:luaTo(GetElement(self.m_root,"imgWeddingStates_CellWeddingItem")):setFile(sStatesImg)
    --结婚时间
