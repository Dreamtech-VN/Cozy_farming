...
function WndDressList:updateDress()
	...
	--当前部位数量
	local s = {"",LocalStrings.BAGTIP31,LocalStrings.BAGTIP32,LocalStrings.BAGTIP33,LocalStrings.BAGTIP34,""}
	...
	for i=2,6 do
		GetElement(self.m_root,"txtTab"..i.."_WndDressList",WZUILabelTTF):setStrokeColor(GlobalMethod:ccc3(105,65,46))
		GetElement(self.m_root,"txtTab"..i.."_WndDressList",WZUILabelTTF):setColor(GlobalMethod:ccc3(195,171,148))
	end
	GetElement(self.m_root,"txtTab"..self.m_nCurrentIndex.."_WndDressList",WZUILabelTTF):setStrokeColor(GlobalMethod:ccc3(127,70,26))
...
function WndDressList:_setUIStaticText()
	local textList = {LocalStrings.CHAT_ALL,LocalStrings.HEAD,LocalStrings.WNDDRESS1,LocalStrings.CLOTHES,LocalStrings.WING,LocalStrings.MONTH_CARDS_TIP6}
	for i=2,6 do
...
function WndDressList:_adaptLanguage_th(  )
	...
	-- ttf2:setRelativePosition(GlobalMethod:ccp(-2.02857,0.995))
	local txtExpired = GetElement(self.m_root,"txtExpired_WndDressList",WZUILabelTTF)
...
function WndDressList:_adaptLanguage_es(  )
	...
	ttf2:setAlignment(kCCTextAlignmentLeft)
	ttf2:setRelativePosition(GlobalMethod:ccp(0.36,0.86))
end
-------------------------------------语言适配End--------------------------------------------
