...
--@brief	更新Cell
--@param	data:物品数据
--@param	showType:显示类型1自己拥有的时装2商城出售的时装
...
function CellDress:updateCell(data,showType)
	...
	WZLog("CellDress:updateCell", Serialize(data))
   	name:setColor(QUALITYCOLOR[data.basicInfo.quality])
	...
	WZLog(data.basicInfo.name,"剩余时间",data.lastTime,data.disappearTime,os.time(),SETITEMSTIME,countdown)
