...
function CellCheckOther4:showDress(tData)
	...
	if "vn" == ProjConfig.LANGUAGE then
		...
		txtTitle:setRelativePosition(GlobalMethod:ccp(0,0.875))
		txtTitle:setFontSize(20)
	end
	--设置标题
	GetElement(self.m_root,"txtTitle_CellCheckOther4",WZUILabelTTF):setText(LocalStrings.CHECKOTHER8)
...
function CellCheckOther4:showDress1(tData)
	...
	if "vn" == ProjConfig.LANGUAGE then
		local txtTitle = GetElement(self.m_root,"txtTitle_CellCheckOther4",WZUILabelTTF)
		txtTitle:setRelativePosition(GlobalMethod:ccp(0.01,0.875))
		txtTitle:setFontSize(20)
	end
	--设置标题
	GetElement(self.m_root,"txtTitle_CellCheckOther4",WZUILabelTTF):setText(LocalStrings.CHECKOTHER8)
...
function CellCheckOther4:onClick(tCell,tag,tData)
	WZLog("CellCheckOther4:onClick",tag)
	local tips
...
function CellCheckOther4:showEquip(tEquip)
	...
	self:addTipsBtn()
	--设置标题
	GetElement(self.m_root,"txtTitle_CellCheckOther4",WZUILabelTTF):setText(LocalStrings.CHECKOTHER7)
	--语言适配
	...
	if "vn" == language then
		GetElement(self.m_root,"txtTitle_CellCheckOther4",WZUILabelTTF):setScale(0.9)
	end	
...
-------------------------------------语言适配Begin------------------------------------------
function CellCheckOther4:_adaptLanguage_tr(  )
	GetElement(self.m_root, "txtTitle_CellCheckOther4", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.00881356,0.875))
end
-------------------------------------语言适配End--------------------------------------------
