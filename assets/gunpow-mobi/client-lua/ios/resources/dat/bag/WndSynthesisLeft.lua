...
function WndSynthesisLeft:_clearPutItem(bQuick)
    ...
    --清除货币信息
    local imgCurrency = GetElement(self.m_root, "imgCost_WndSynthesisLeft", WZUIImage)
    imgCurrency:setFile("")
    local txtCurrency = GetElement(self.m_root, "txtValue_WndSynthesisLeft", WZUILabelTTF)
    txtCurrency:setText("")
...
-------------------------------------语言适配Begin------------------------------------------
function WndSynthesisLeft:_adaptLanguage_th(    )
    GetElement(self.m_root,"txtSaleTitie_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.SYNTHESIS)
    GetElement(self.m_root,"cost_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.BAGTIP15)
    GetElement(self.m_root,"txtRapid_WndSynthesis",WZUILabelTTF):setText(LocalStrings.BAGTIP13)
end

function WndSynthesisLeft:_adaptLanguage_en(    )
    GetElement(self.m_root,"txtSaleTitie_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.SYNTHESIS)
    GetElement(self.m_root,"cost_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.BAGTIP15)
    GetElement(self.m_root,"txtRapid_WndSynthesis",WZUILabelTTF):setText(LocalStrings.BAGTIP13)
end

function WndSynthesisLeft:_adaptLanguage_pt(    )
    GetElement(self.m_root,"txtSaleTitie_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.SYNTHESIS)
    GetElement(self.m_root,"cost_WndSynthesisLeft",WZUILabelTTF):setText(LocalStrings.BAGTIP15)
    GetElement(self.m_root,"txtRapid_WndSynthesis",WZUILabelTTF):setText(LocalStrings.BAGTIP13)
    
    GetElement(self.m_root,"cost_WndSynthesisLeft",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.305135,0.5))
    GetElement(self.m_root,"imgCost_WndSynthesisLeft",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.636757,0.5))
    GetElement(self.m_root,"txtValue_WndSynthesisLeft",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.693514,0.5))

    GetElement(self.m_root,"txtQuickCraft_WndSynthesisLeft",WZUILabelTTF):setScale(0.9)
end

function WndSynthesisLeft:_adaptLanguage_es(  )
    GetElement(self.m_root,"cost_WndSynthesisLeft",WZUILabelTTF):setFontSize(18)
    local imgCost = GetElement(self.m_root,"imgCost_WndSynthesisLeft",WZUIImage)
    imgCost:setRelativePosition(GlobalMethod:ccp(0.58,0.5))
    local txtValue = GetElement(self.m_root,"txtValue_WndSynthesisLeft",WZUILabelTTF)
    txtValue:setRelativePosition(GlobalMethod:ccp(0.64,0.5))

    GetElement(self.m_root,"txtQuickCraft_WndSynthesisLeft",WZUILabelTTF):setScale(0.7)
