...
function WndEquip:_setTextColorByTag(tag)
	...
	if tag == 1 then
		...
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquip"),GlobalMethod:ccc3(195,171,148),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquip"),GlobalMethod:ccc3(195,171,148),GlobalMethod:ccc3(105,65,46))
    	GetElement(self.m_root, "imgArms_WndEquip", WZUI9Image):setVisible(true)
	elseif tag == 2 then
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquip"),GlobalMethod:ccc3(195,171,148),GlobalMethod:ccc3(105,65,46))
...
function WndEquip:_setTextColor(txt,color,strcolor)
	...
	strcolor = strcolor or GlobalMethod:ccc3(127,70,26)
