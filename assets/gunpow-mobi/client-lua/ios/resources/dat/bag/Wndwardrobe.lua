...
function Wndwardrobe:_addTop()
    local cell,tcell = CellTopHandle:createElement()
    self.m_root:addChild(cell)
    tcell:setTopData("ui/bag/common_icon_yichu.png",Wndwardrobe,Wndwardrobe.onCloseClick,true,false,false,"Wndwardrobe")
end
...
function Wndwardrobe:showPlayer()
    ...
    if not self.conPlayer then
		...
		conPlayer:getAnimNode():setRelativePosition(GlobalMethod:ccp(0.536,-0.041))
