...
function WndEquipNew:onGemSelect(element)
	...
	self.m_nItem = 1
	self:_setTextColorByTag(self.m_nBagIndex)
	self:setGemData(CacheCenter:getGemList())
	self:_updateItem()--更新道具列表
    GetElement(self.m_root, "itemNum_WndEquipNew", WZUILabelTTF):setVisible(false)
end
...
function WndEquipNew:_setTextColorByTag(tag)
	...
	if tag == 1 then
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquipNew"))
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtGem_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
    	GetElement(self.m_root, "imgArms_WndEquipNew", WZUI9Image):setVisible(true)
	elseif tag == 2 then
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquipNew"))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtGem_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
	...
	elseif tag == 3 then
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtGem_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
	...
	elseif tag == 4 then
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtGem_WndEquipNew"))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
	...
	elseif tag == 5 then
		...
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"))
    	GetElement(self.m_root, "imgSkin_WndEquipNew", WZUI9Image):setVisible(true)
	else
		self:_setTextColor(self.m_root:getChildElement("txtArms_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtDress_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtOther_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtAll_WndEquipNew"))
		self:_setTextColor(self.m_root:getChildElement("txtSkin_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
		self:_setTextColor(self.m_root:getChildElement("txtGem_WndEquipNew"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(105,65,46))
...
function WndEquipNew:_setTextColor(txt,color,strcolor)
	...
	strcolor = strcolor or GlobalMethod:ccc3(128,54,13)
