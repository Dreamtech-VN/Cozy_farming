...
function WndWorldTeamBossInfoView:_adaptLanguage_en(  )
	GetElement(self.m_root, "txtTeamHurt_WndWorldTeamBossInfoView", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.66,0.82))
	GetElement(self.m_root, "txtMyHurt_WndWorldTeamBossInfoView", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.66,0.56))
	GetElement(self.m_root, "txtRoundNum_WndWorldTeamBossInfoView", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.66,0.3))
end
