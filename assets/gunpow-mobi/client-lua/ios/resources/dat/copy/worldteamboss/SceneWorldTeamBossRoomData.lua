...
--@brief    玩家被邀请进入副本房间
function SceneWorldTeamBossRoom:beInvited(roomId , playerName,mapId, password, roomChannel)
...
function SceneWorldTeamBossRoom:receiveStartOk(battleId, mapId, playerCount, playerId, serverId, playerName, playerTitle, playerGuild, playerLevel, playerSex, maxHP, maxPF, maxSP, attack, critRate, defence, injuryFree, wreckDefense, reduceCrit, power, armor, constitution, agility, lucky, inspire, headId, faceId, bodyId, weaponId, wingId, item_id, skillId, playerBuffCount, buffId, petAnimation, petGift, guaiBattleId, guaiId, guaiMaxHP, guaiNowHP, guaiAttack, petAdvancedLevel, colour, bodycolour, footmark)
	...
	WBattleGlobal:getCurrent().m_tMakePairOk ={
        ...
        buffId=buffId,petId=petAnimation,petSkill = skillId,petLevel=petAdvancedLevel,petSkillId=petAnimation,petParam=petGift, guaiBattleId=guaiBattleId,guaiId=guaiId,guaiMaxHP=tempGuaiMaxHp, guaiNowHP=tempGuaiNowHp,guaiAtk=guaiAttack,guaiLv = guaiLv,weaponSkill=skillId, 
...
function SceneWorldTeamBossRoom:addTop()
    ...
    tcell:setTopData("ui/common/common_icon_sylz.png",SceneWorldTeamBossRoom,SceneWorldTeamBossRoom.onClose,true,true,true,"SceneWorldTeamBossRoom")
end
