...
function WndPetGift:_adaptLanguage_vn()
  GetElement(self.m_root,"imgLeftArrow_WndPetGift",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.23,0.5))
  GetElement(self.m_root,"imgRightArrow_WndPetGift",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.77,0.5))
end
