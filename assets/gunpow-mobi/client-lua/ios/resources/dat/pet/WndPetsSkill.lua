...
function WndPetsSkill:setSkillInfo()
  ...
  self:setHasGoods()
  self:setUseGoods()
  GetElement(self.m_root,"txtLvE6_WndPetsSkill",WZUILabelTTF):setText(self:getCost567())
  --self:_setView()
end
...
function WndPetsSkill:setSkillList(nTag,nSkillId)
  ...
  --128，54，13
  --198，130，255
  local name = {LocalStrings.PETSKILL1, LocalStrings.PETSKILL2,LocalStrings.PETSKILL3,LocalStrings.PETSKILL4}
  local desc = {LocalStrings.PETSKILLDESC1, LocalStrings.PETSKILLDESC2,LocalStrings.PETSKILLDESC3,LocalStrings.PETSKILLDESC4}
...
function WndPetsSkill:setHasGoods()
  ...
  GetElement(self.m_root,"txtLvE2_WndPetsSkill",WZUILabelTTF):setText(self.m_tPetDate[2][1])
end

--@brief 设置当前消耗材料的显示
function WndPetsSkill:setUseGoods()
  local cost = self:getCost()
  GetElement(self.m_root,"txtLvE3_WndPetsSkill",WZUILabelTTF):setText(cost)
...
function WndPetsSkill:onSkillUpdate(element)
  ...
  if tonumber(CacheCenter:getPlayerItemCountById(104)) < cost1  then
    --checkIsOnSale(104)
...
function WndPetsSkill:updatePlayerItemData()
  ...
  local txt3 = string.format(LocalStrings.PETHASNUM,CacheCenter:getPlayerItemCountById(567))
  GetElement(self.m_root,"txtLvE7_WndPetsSkill",WZUILabelTTF):setText(txt3)
  -- GetElement(self.m_root,"txtLv4_WndPetsSkill",WZUILabelTTF):setText(CacheCenter:getPlayerItemCountById(105))
end
...
function WndPetsSkill:updatePlayerPetInfoData()
  ...
  if self.m_bISAlter == true then
    ...
    PopupResult("ui/pet/common_icon_lwcg.png",0.3,0.5)
  end
...
-------------------------------------私有方法模块Begin--------------------------------------
function WndPetsSkill:_cleanDate()
  WZLog("WndPetsSkill:_cleanDate")
  self.m_petSkillLockId = 0
  for i = 1, 4 do
     GetElement(self.m_root,"imgBtn"..i.."_WndPetsSkill",WZUIImage):setFile("common/button/checkbox_unsel.png")
  end
end
