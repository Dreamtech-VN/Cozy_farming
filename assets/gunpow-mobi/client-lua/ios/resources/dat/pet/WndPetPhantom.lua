...
function WndPetPhantom:_showPetList()
	...
	if self.m_tPetData == nil or #self.m_tPetData == 0 then
		if ProjConfig.LANNGUAGE == "en" or ProjConfig.LANNGUAGE == "es" or ProjConfig.LANNGUAGE == "pt" then
			ShowPanelNullTip(conRight, LocalStrings.PET_TEXT5, nil, nil, nil ,nil ,2)
		else
