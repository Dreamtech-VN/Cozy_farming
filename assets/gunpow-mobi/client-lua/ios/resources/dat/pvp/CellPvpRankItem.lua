...
function CellPvpRankItem:_showName()
    local tThreeIcon = {"ui/common/common_icon_1st.png", "ui/common/common_icon_2nd.png", "ui/common/common_icon_3rd.png"}
    ...
    if self.m_tData.rank <= 3 then
        ...
        local laftxtRankNum = GetElement(self.m_root, "laftxtRankNum_CellPvpRankItem", WZUILabelAtlasFont)
        if laftxtRankNum then
            laftxtRankNum:setText(self.m_tData.rank)
        end
    end
...
--    txtName:setText(sNameContent)
    ...
    txtServerName:setRelativePosition(GlobalMethod:ccp(0.13,0.5))
