...
function ScenePvp:_addTop()
    ...
    tcell:setTopData("ui/common/common_icon_jingjichang.png",ScenePvp,ScenePvp.onTempClose,true,true,true,"ScenePvp")
...
function ScenePvp:_adaptLanguage_es(  )
    ...
    GetElement(self.m_root,"txtET_ScenePvp",WZUILabelTTF):setScale(0.66)
