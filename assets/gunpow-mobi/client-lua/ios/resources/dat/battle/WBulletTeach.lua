...
function WBulletTeach:calculateHurt(distance,shootHero,targetHero,petCoef,isNotcalculate)
    ...
    --WZLog("WBulletTeach:calculateHurt ZERO-3",hurt, tostring(shootHero:getHurtAddPercent()), tostring(targetHero:getBeHurtAddPercent()))
    ...
    --WZLog("WBulletTeach:calculateHurt ZERO-4",hurt, targetHero:getBeHurtAddPercent() or 0, shootHero:getHurtAddValue() or 0)
