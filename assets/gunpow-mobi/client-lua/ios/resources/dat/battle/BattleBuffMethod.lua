...
function BattleBuffMethod:getBuffValue(hero,effectType,param)
    --属性值
    if effectType == EffectTypeConfig.CHANGE_ATTRIBUTE_VALUE or
        effectType == EffectTypeConfig.CHANGE_ATTRIBUTE_PERCENT then
    ...
    --百分比
    if effectType == EffectTypeConfig.CHANGE_HURT_PERCENT or
        effectType == EffectTypeConfig.CHANGE_BEHURT_PERCENT then
