...
--@note		包括物理层和表现层的改变
function BattleMapManager:drawBroke(point,lpBreakCircle,lpBreakCircleMark,nBreakWidth,nBreakHeight,isMapErosion)
	if nBreakWidth and nBreakHeight and (nBreakWidth <= 0 or nBreakHeight <= 0) then 
        return true
    end
    if isMapErosion == nil and (nBreakWidth > 700 or nBreakHeight > 700) then
