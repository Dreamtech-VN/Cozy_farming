...
function BattleMsgTeachStep4:init()
	...
	if self.m_nStep == 1 then
		...
		table.insert(self.m_tStepFunction,{self._readyFlyFinish,nil,BattleCommon:getPointTable(30,13.5)})
	...
	elseif self.m_nStep == 3 then
		...
		table.insert(self.m_tStepFunction,{self._waitShowingMyHudEnd,nil,6,BattleCommon:getPointTable(30, 180),-90,true,BattleCommon:getPointTable(10, 0)})
		table.insert(self.m_tStepFunction,{self._readyShoot,nil,2,BattleCommon:getPointTable(-29.5,18)})
		table.insert(self.m_tStepFunction,{self._startShoot,nil,2,BattleCommon:getPointTable(-29.5,18)})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"1-16"})
		table.insert(self.m_tStepFunction,{self._shootOk})
	...
	elseif self.m_nStep == 5 then
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"5-12"})
	...
	elseif self.m_nStep == 10 then
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-3"})
		...
		table.insert(self.m_tStepFunction,{self._readyShoot,nil,1,BattleCommon:getPointTable(28,32)})
		table.insert(self.m_tStepFunction,{self._startShoot,nil,1,BattleCommon:getPointTable(28,32)})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-4"})
		table.insert(self.m_tStepFunction,{self._shootOk})
		table.insert(self.m_tStepFunction,{self._msgOver})
	...
	elseif self.m_nStep == 11 then
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-6"})
		...
		-- table.insert(self.m_tStepFunction,{self._showOk})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-8"})
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-9"})
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-10"})
		table.insert(self.m_tStepFunction,{self._skillUse,nil,25,2,WndBattleHud.m_root})
		table.insert(self.m_tStepFunction,{self._skillUseOk,nil,1,1})

		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-11"})
		-- table.insert(self.m_tStepFunction,{self._show,nil,30,3,WndBattleHud.m_root, true})
		-- table.insert(self.m_tStepFunction,{self._showOk})
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-12"})
		table.insert(self.m_tStepFunction,{self._shootOk})
	...
	elseif self.m_nStep == 12 then
		...
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-15"})
		table.insert(self.m_tStepFunction,{self._skillUse,nil,25,3,WndBattleHud.m_root})
		table.insert(self.m_tStepFunction,{self._skillUseOk,nil,3,nil})

		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-16"})
		-- table.insert(self.m_tStepFunction,{self._show,nil,30,7,WndBattleHud.m_root})
		-- table.insert(self.m_tStepFunction,{self._showOk})

		table.insert(self.m_tStepFunction,{self._waitShowingMyHudEnd,nil,4,BattleCommon:getPointTable(-485, 350),0,false,nil})
		table.insert(self.m_tStepFunction,{self._readyShoot,nil,2,BattleCommon:getPointTable(23,32)})
		table.insert(self.m_tStepFunction,{self._startShoot,nil,2,BattleCommon:getPointTable(23,32)})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-17"})
		table.insert(self.m_tStepFunction,{self._shootOk})
	...
	elseif self.m_nStep == 14 then
		...
		-- table.insert(self.m_tStepFunction,{self._cleanChat})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-5"})
		table.insert(self.m_tStepFunction,{self._msgOver,nil,true})
	elseif self.m_nStep == 15 then
		-- table.insert(self.m_tStepFunction,{self._teachChat,nil,207,25})
		-- table.insert(self.m_tStepFunction,{self._cleanChat})
		table.insert(self.m_tStepFunction,{self._postTeach,nil,"0-13"})
		table.insert(self.m_tStepFunction,{self._msgOver,nil,true})
	end
...
function BattleMsgTeachStep4:_weaponGet()
	WndRewardShow:showById({4900},{1},nil,-3)
	TeachGroup1.WEAPONGET = nil
