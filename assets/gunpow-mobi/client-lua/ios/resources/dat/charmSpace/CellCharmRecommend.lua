...
function CellCharmRecommend:_update()
	...
	local txtLevel2 = GetElement(self.m_root,"txtLevel2_CellCharmRecommend",WZUILabelTTF)
	local txtName1 = GetElement(self.m_root,"txtName1_CellCharmRecommend",WZUILabelTTF)
	local txtName2 = GetElement(self.m_root,"txtName2_CellCharmRecommend",WZUILabelTTF)
	...
	elseif self.cross == 1 then
		img:setVisible(true)
		txtName2:setText(self.playerName)
		txtLevel2:setText("Lv"..self.level)
	end
