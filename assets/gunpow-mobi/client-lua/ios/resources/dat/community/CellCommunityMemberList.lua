...
function CellCommunityMemberList:setCellContentFontColor(nRed,nGreen,nBlue)
	if self.m_root == nil  then 
		WZLog(" CellCommunityMemberList:setCellContentFontColor(GlobalMethod:ccc3(nRed,nGreen,nBlue)) self.m_root is nil ")
		return 
	end 
	
	--排名 
	local txtRanking = self.m_root:getChildElement("txtRanking_CellCommunityMemberList")
	if txtRanking ~= nil then 
		txtRanking = WZUILabelTTF:luaTo(txtRanking)
		if txtRanking ~= nil then 
			txtRanking:setColor(GlobalMethod:ccc3(nRed,nGreen,nBlue))
		end 
	end 
...
function CellCommunityMemberList:onLoadData(element)
	...
	if txtRanking ~= nil then 
		txtRanking = WZUILabelTTF:luaTo(txtRanking)
		if txtRanking ~= nil and self.m_nTxtRanking  ~= nil then 
			txtRanking:setText(tostring(self.m_nTxtRanking))
		end 
	end 
	...
	--	GetElement(self.m_root, "imgBtn1_CellCommunityMemberList", WZUI9Image):setFile("ui/common/common_scale9_di4.png")
	--	GetElement(self.m_root, "imgBtn2_CellCommunityMemberList", WZUI9Image):setFile("ui/common/common_scale9_di4.png")
	--else
	--	GetElement(self.m_root, "imgBtn1_CellCommunityMemberList", WZUI9Image):setFile("ui/common/common_scale9_di10.png")
	--	GetElement(self.m_root, "imgBtn2_CellCommunityMemberList", WZUI9Image):setFile("ui/common/common_scale9_di10.png")
	--end
end
...
function CellCommunityMemberList:_setWhichAtlasFontVisable(nTag,sLevel)
	...
	if nTag <= 0  then   --紫色
		...
		if txtLevel ~= nil then 
			...
			if txtLevel ~= nil then 
				txtLevel:setText(tostring("Lv"..self.m_nLevelNum))
