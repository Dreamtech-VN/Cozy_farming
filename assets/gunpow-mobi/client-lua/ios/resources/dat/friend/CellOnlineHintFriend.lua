...
function CellOnlineHintFriend:_showHeadIcon()
    ...
    local cellElement =  CellHead:show(conHead,self.m_tFriend.headItemId,self.m_tFriend.faceItemId,self.m_tFriend.sex, bIsOnline, nil, self.m_tFriend.vipLevel, self.m_tFriend.headColor)
