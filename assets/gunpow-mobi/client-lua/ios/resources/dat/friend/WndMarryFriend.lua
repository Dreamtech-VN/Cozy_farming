...
function WndMarryFriend:setChoicesItem(index)
	local imgSel = WZUIImage:luaTo(self.m_root:getChildElement("imgAll_WndMarryFriend"))
	imgSel:setFile("ui/athletic_Hall/gou.png")
	self.m_selectIndex = 1
	if index == 1 then
		imgSel:setFile("ui/athletic_Hall/kuang.png")
		self.m_selectIndex = 0
	end
end

function WndMarryFriend:onChoose(element)
	SoundManager:playEffectSound(SoundDefine.E_S_CLICK_BTN)
	self:setChoicesItem(self.m_selectIndex)
	...
	for i=0,count-1 do 
		...
		tCell:setChoicesItem(1-self.m_selectIndex) 
	end
end
