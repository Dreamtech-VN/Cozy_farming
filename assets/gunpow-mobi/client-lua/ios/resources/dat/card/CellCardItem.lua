...
function CellCardItem:_update()
    -- body
    local qualityRect = {"ui/card/kapai_scale9_lv.png", "ui/card/kapai_scale9_lan.png", "ui/card/kapai_scale9_zi.png", "ui/card/kapai_scale9_cheng.png"}
    --卡牌图标
    local imgCardIcon = GetElement(self.m_root, "imgCardIcon_CellCardItem", WZUIImage)
    imgCardIcon:setFile(self.m_tData.card_icon)
    --品质框
    local imgQualityRect = GetElement(self.m_root, "imgQualityRect_CellCardItem", WZUIImage)
