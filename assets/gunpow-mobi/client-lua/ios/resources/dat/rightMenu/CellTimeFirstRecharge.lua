...
function CellTimeFirstRecharge:_showBK()
    ...
    if imgBK then 
        if self.m_nActivityType == g_tGameActivityTypes.ACTIVITY_THREETIMES_DIAMOND then
            imgBK:setFile("ui/gameActivity/activity_pic_sbzsfl.png")
        end
    end
end
...
function CellTimeFirstRecharge:_setDynamicText()
    ...
    if self.m_nActivityType == g_tGameActivityTypes.ACTIVITY_THREETIMES_DIAMOND then
        ...
        txtThreeWorld:setText(string.format(LocalStrings.GAMEACTIVITY_TIPTEXT4, LocalStrings.COMMUNITYWARHISTORY_NUMBER[3]))
    else
