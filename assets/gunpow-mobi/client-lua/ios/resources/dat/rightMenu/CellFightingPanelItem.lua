...
function  CellFightingPanelItem:BtnDoneEvent()
    ...
    if wndtotalrewardlist ~= nil then
        ...
        tLua:_setItemListForActivity(tItemId,tItemNum,0.45-ItemTag+moveCellItem,#self.m_tData,true,self.status)
    end
end
...
function CellFightingPanelItem:_initItemMsg(  )
    local txtFightValue = GetElement(self.m_root,"txtFightValue_CellFightingPanelItem",WZUILabelTTF)
    if txtFightValue then
        txtFightValue:setText(LocalStrings.FIGHTING_TO)
    end
    
    local txtFight = GetElement(self.m_root,"txtFight_CellFightingPanelItem",WZUILabelAtlasFont)
    if txtFight then 
        txtFight:setText(tostring(self.target))
    end 
    ...
    if -1==tonumber(self.status) or tonumber(self.status)==1 then
        ...
        txtBtnItem:setStrokeColor(GlobalMethod:ccc3(79,60,48))
...
function CellFightingPanelItem:_adaptLanguage_en(  )
    ...
    if txtFight ~= nil then 
        txtFight:setRelativePosition(GlobalMethod:ccp(0.34375,0.5))
        txtFight:setScale(0.76)
    end 

    GetElement(self.m_root,"imgArrow_CellFightingPanelItem",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.65,0.5))
...
function CellFightingPanelItem:_adaptLanguage_pt(  )
    local txtFight = GetElement(self.m_root,"txtFight_CellFightingPanelItem",WZUILabelAtlasFont)
    if txtFight ~= nil then 
        txtFight:setRelativePosition(GlobalMethod:ccp(0.33,0.5))
        txtFight:setScale(0.76)
    end
    local txtFightValue = GetElement(self.m_root,"txtFightValue_CellFightingPanelItem",WZUILabelTTF)
    txtFightValue:setFontSize(18)
end

function CellFightingPanelItem:_adaptLanguage_vn(  )
    local txtFight = GetElement(self.m_root,"txtFight_CellFightingPanelItem",WZUILabelAtlasFont)
    if txtFight ~= nil then 
        txtFight:setRelativePosition(GlobalMethod:ccp(0.275,0.5))
    end 
    GetElement(self.m_root,"imgArrow_CellFightingPanelItem",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.6,0.5))
end

function CellFightingPanelItem:_adaptLanguage_es(  )
    local txtFight = GetElement(self.m_root,"txtFight_CellFightingPanelItem",WZUILabelAtlasFont)
    txtFight:setRelativePosition(GlobalMethod:ccp(0.28,0.5))
...
function CellFightingPanelItem:_adaptLanguage_tr(  )
    local txtFight = GetElement(self.m_root,"txtFight_CellFightingPanelItem",WZUILabelAtlasFont)
    if txtFight ~= nil then 
        txtFight:setRelativePosition(GlobalMethod:ccp(0.483333,0.5))
        --txtFight:setScale(0.76)
    end 

    GetElement(self.m_root,"imgArrow_CellFightingPanelItem",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.781249,0.5))
end
-------------------------------------语言适配End----------------------------------------------