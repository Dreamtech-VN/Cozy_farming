...
function CellCopyHallList:_update()
    ...
    local difPath = {"ui/copy/copy_icon_jd1.png","ui/copy/copy_icon_kn1.png","ui/copy/copy_icon_dy1.png" }
    local txtPath = {"ui/common/common_icon_zdjd.png","ui/common/common_icon_zdkn.png","ui/common/common_icon_zddy.png"}
