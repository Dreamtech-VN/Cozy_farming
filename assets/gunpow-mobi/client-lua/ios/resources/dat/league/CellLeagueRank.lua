...
function CellLeagueRank:onLoadData(element)
	...
	if self.m_tData.rank == 1 then
		GetElement(self.m_root,"img_CellLeagueRank",WZUIImage):setFile("ui/common/common_icon_1st.png")
	elseif self.m_tData.rank == 2 then
		GetElement(self.m_root,"img_CellLeagueRank",WZUIImage):setFile("ui/common/common_icon_2nd.png")
	elseif self.m_tData.rank == 3 then
		GetElement(self.m_root,"img_CellLeagueRank",WZUIImage):setFile("ui/common/common_icon_3rd.png")
	else
...
function CellLeagueRank:setGreen()
	...
	GetElement(self.m_root, "imgBtn1_CellLeagueRank", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
	GetElement(self.m_root, "imgBtn2_CellLeagueRank", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
	GetElement(self.m_root, "imgBtn3_CellLeagueRank", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
end
