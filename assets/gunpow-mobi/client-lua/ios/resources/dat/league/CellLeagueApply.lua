...
function CellLeagueApply:setGreen()
	...
	GetElement(self.m_root, "imgBtn1_CellLeagueApply", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
	GetElement(self.m_root, "imgBtn2_CellLeagueApply", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
	GetElement(self.m_root, "imgBtn3_CellLeagueApply", WZUI9Image):setFile("ui/common/common_scale9_di38.png")
end
