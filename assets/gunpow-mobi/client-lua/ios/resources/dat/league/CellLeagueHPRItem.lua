...
function CellLeagueHPRItem:setHighLight(bClick)
    ...
    if bClick then
        ...
        imgSel = WZUIImage:luaTo(imgSel)
        imgSel:setFile("ui/common/common_btn_huodong_sel.png")
        imgSel:setUseOriginSize(true)
        imgSel:setRelativePosition(GlobalMethod:ccp(0.53,0.503))
        btnLeft:addChild(imgSel, 0, 999)
    else
...
function CellLeagueHPRItem:_update()
    ...
    if self.m_nRoundId then
        ...
        local sFormat = [[<A IMG = "ui/common_num/common_num_yaoqianshuzi.png" Z ="0.7" W = "26" H = "34" CHAR = "0">%d</A><I>ui/hero/hero_icon_jie.png</I>]]
        ...
        txtName:setRelativePosition(GlobalMethod:ccp(0.5,0.28))
