...
function CellLeagueMatch1:onLoadData(element)
	...
	for i=1,8 do
		...
		for j=1,4 do
			...
			--轮换战队位置
			local teamPosition = {ccp(0.17,0.725),ccp(0.83,0.725),ccp(0.17,0.272),ccp(0.83,0.272)}
			local resultPosition = {ccp(0.95,0.27),ccp(0,0.27),ccp(0.95,0.27),ccp(0,0.27)}
			...
			if tonumber(self.m_nRound) == 2 then
				teamPosition = {ccp(0.17,0.725),ccp(0.17,0.272),ccp(0.83,0.725),ccp(0.83,0.272)}
				resultPosition = {ccp(0.95,0.27),ccp(0.95,0.27),ccp(0,0.27),ccp(0,0.27)}
				if ProjConfig.LANGUAGE == "vn" then
					resultPosition = {ccp(0.79,0.27),ccp(0.79,0.27),ccp(0.2,0.27),ccp(0.2,0.27)}
				end
			elseif tonumber(self.m_nRound) == 3 then
				teamPosition = {ccp(0.17,0.725),ccp(0.17,0.272),ccp(0.83,0.272),ccp(0.83,0.725)}
				resultPosition = {ccp(0.95,0.27),ccp(0.95,0.27),ccp(0,0.27),ccp(0,0.27)}
				if ProjConfig.LANGUAGE == "vn" then
					resultPosition = {ccp(0.79,0.27),ccp(0.79,0.27),ccp(0.2,0.27),ccp(0.2,0.27)}
				end
