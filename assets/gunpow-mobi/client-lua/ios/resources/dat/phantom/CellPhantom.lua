...
function CellPhantom:update() 
	...
	--品质框
	local qualityFile = {"ui/common/huanhua_scale9_lv.png","ui/common/huanhua_scale9_lan.png",
		"ui/common/huanhua_scale9_zi.png","ui/common/huanhua_scale9_cheng.png"}
	...
	if tData.own then
		if tData.sp_cost == -1 then
			...
			GetElement(self.m_root,"txtMax",WZUILabelTTF):setVisible(true)
		else
	...
	if needNum ~= nil and needNum ~= 0 then
		GetElement(self.m_root,"progressBar",WZUIProgress):setPercentage(debrisNum/needNum*100)
	end
...
function CellPhantom:_adaptLanguage_en(  )
	GetElement(self.m_root,"ttfName_CellPhantom", WZUILabelTTF):setScale(0.6)
	GetElement(self.m_root,"ttfName_CellPhantom", WZUILabelTTF):setMaxLength(50)
	GetElement(self.m_root,"ttfName_CellPhantom", WZUILabelTTF):setDimensions(GlobalMethod:CCSize(160))
end
