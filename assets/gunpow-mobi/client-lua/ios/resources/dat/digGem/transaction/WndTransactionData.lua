...
function WndTransaction:setData2(commodityIds, itemIds, quantitys, saleNums, saleTime)
    if self.m_root == nil then return end
    self.m_tDataList2 = {}
...
function WndTransaction:setData4(logType, itemIds, itemNums, prices, addSpar, commodityTime)
    if self.m_root == nil then return end
    self.m_tDataList4 = {}
