...
function CellGemTool:onClickBtn(element)
    ...
    if self.m_tData.leftTime < 60 then
        --购买
...
function CellGemTool:_update()
    ...
    if ftxtPrice then
        if tData.leftTime < 60 then
            local sTimeFormat = [[<T C="127,70,26" S="22" P="1">%s</T><I Z="0.5" P="1">%s</I><T C="127,70,26" S="22" P="1">%d</T>]]
            ...
            local sTimeFormat = [[<T C="127,70,26" S="22" P="0">%s</T><T C="255,89,74" S="22" P="0">%d%s</T>]]
