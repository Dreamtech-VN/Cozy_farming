...
--    local txtContent = GetElement(self.m_root, "txtContent_WndConfirmBox", WZUILabelTTF)
    ...
    if self.m_tMsgData.bIsOnlyOneButton == true then
        ...
        GetElement(self.m_root, "btnConfirm_WndConfirmBox", WZUIButton):setRelativePosition(ccp(0.5,0.22))
    end
...
function WndConfirmBox:_adaptLanguage_vn()
	...
	GetElement(self.m_root,"txtContext_WndConfirmBox",WZUILabelTTF):setDimensions(GlobalMethod:CCSize(380))
end
