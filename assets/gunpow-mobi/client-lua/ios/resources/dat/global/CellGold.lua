...
function CellGold:onClickBtn(element)
	...
	elseif nTag == 23 or nTag == 61 or nTag == 165 or nTag == 164 or nTag == 107 or nTag == 163 or nTag == 59 or nTag == 26 or nTag == 70 or nTag == 79 then
...
function CellGold:onClickOtherCoin(nTag, ptTips)
	...
	txtDes:setColor(GlobalMethod:ccc3(255,236,193))
	...
	if ProjConfig.LANGUAGE == "en" or ProjConfig.LANGUAGE == "vn" or ProjConfig.LANGUAGE == "pt" 
		...
		sFormat = [[<T C="255,236,193" S="18" P="1">%s</T><BR></BR><T C="255,236,193" S="18" P="1">%s</T>]]
	end
...
--@brief 	觉醒界面创建重置按钮
function CellGold:createResetBtn(tCell, func)
	-- body
	...
	btnReset:setRelativePosition(GlobalMethod:ccp(0.91, 0.5))
	btnReset:setTag(88)
	self.m_root:addChild(btnReset)
