...
function ProtocolProcessorExploration:regAll()
	...
	--协议错误处理	
	--@brief	获取玩家的转生信息失败
	self:regProtocolCallbackFunction( Protocol.MAIN_MAIL, Protocol.REBIRTH_GetRebirthInfo, "ProtocolProcessorExploration:parse_REBIRTH_GetRebirthErrorMessage", "is")
