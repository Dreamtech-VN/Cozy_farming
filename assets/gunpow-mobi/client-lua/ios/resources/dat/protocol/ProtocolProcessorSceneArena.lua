...
--@brief	查找房间
function ProtocolProcessorSceneArena:send_ROOM_SelectRoom(roomId,roomChannel,passWord )
...
function ProtocolProcessorSceneArena:send_ROOM_QuickGame(roomChannel,battleMode,schedule)
