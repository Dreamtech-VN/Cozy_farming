...
function ProtocolProcessorWndCharmRank:regAll()
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_RANK, Protocol.RANK_GetRankRecordOK, "ProtocolProcessorWndCharmRank:parse_RANK_GetRankRecordOK", "tvtvivivsvivivtvivsvsvsvsvsvsvsvtvsvivs")
...
function ProtocolProcessorWndCharmRank:parse_RANK_GetRankRecordOK(rankType, trendRank, ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, vipLevel, param8, headColor, param9)
    -- rankType : 排行榜类型
    ...
    -- headColor : 头颜色索引
    -- param9 : 妻子头颜色索引
    WZLog("ProtocolProcessorWndCharmRank:parse_RANK_GetRankRecordOK",rankType, type(param8), Serialize(VectorToTable(param8)))
...
function ProtocolProcessorWndCharmRank:parse_RANK_GetPlayerRankOK(myRank, rankValue, rankExp, myTrendRank, rankType, canWorship)
    ...
    if rankType == 26 or rankType == 48 then
        WndCharmSpace:_update2(2)
    elseif rankType == 27 or rankType == 49 then
