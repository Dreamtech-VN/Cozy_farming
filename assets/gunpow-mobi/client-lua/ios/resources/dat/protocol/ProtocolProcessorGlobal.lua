...
function ProtocolProcessorGlobal:regAll()
	...
	-----关于聊天
	--@brief	接收聊天信息
	self:regProtocolCallbackFunction( Protocol.MAIN_CHAT, Protocol.CHAT_ReceiveMessage, "ProtocolProcessorGlobal:parse_CHAT_ReceiveMessage", "tisissittiiittiiiisi")

	--@brief	进入房间成功（ROOM_EnterRoomOk = 6）
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_EnterRoomOk, "ProtocolProcessorGlobal:parse_ROOM_EnterRoomOk", "iiiiiiiiiivbvivivsvivbvivivivivsssvivsvivivivsvivsvivsvivissssssvivivivivi")


    --@brief	被邀请(副本房间)（BOSSMAPROOM_BeInvite = 23）
	self:regProtocolCallbackFunction( Protocol.MAIN_BOSSMAPROOM, Protocol.BOSSMAPROOM_BeInvite, "ProtocolProcessorGlobal:parse_BOSSMAPROOM_BeInvite", "isisii")
    
	--@brief	被邀请
	self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_BeInvite, "ProtocolProcessorGlobal:parse_ROOM_BeInvite", "iissii")
    ...
    --@brief	发送副本列表
    self:regProtocolCallbackFunction( Protocol.MAIN_BOSSMAPROOM, Protocol.BOSSMAPROOM_SendBossMapList, "ProtocolProcessorGlobal:parse_BOSSMAPROOM_SendBossMapList", "ivivivi")
   ...
   self:regProtocolCallbackFunction( Protocol.MAIN_WEDDING, Protocol.WEDDING_JoinWeddingOK, "ProtocolProcessorGlobal:parse_WEDDING_JoinWeddingOK", "ssvivsvivivivivtvntiiisvtviviiiiiiiiivi")
	...
	--@brief	观战同步信息成功
	self:regProtocolCallbackFunction( Protocol.MAIN_HERO, Protocol.PLAYER_SynchronousWatchOk, "ProtocolProcessorGlobal:parse_PLAYER_SynchronousWatchOk", "iviviviviviviviviviviviviviviviviviviviviii")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_GetFunnyMatchInfoOk, "ProtocolProcessorGlobal:parse_ROOM_GetFunnyMatchInfoOk", "vtvtvs")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_ZONE, Protocol.ZONE_GetBoxInfo, "ProtocolProcessorGlobal:send_ZONE_GetBoxInfo_ErrorProcess", "is" )
    --@brief    获取宝箱信息（ZONE_GetBoxInfoOk = 6）
    self:regProtocolCallbackFunction( Protocol.MAIN_ZONE, Protocol.ZONE_GetBoxInfoOk, "ProtocolProcessorGlobal:parse_ZONE_GetBoxInfoOk", "vtvivti")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_ACTIVITY, Protocol.ACTIVITY_GetUserBackActivityStatusOk, "ProtocolProcessorGlobal:parse_ACTIVITY_GetUserBackActivityStatusOk", "t")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_CheckPwPunishOk, "ProtocolProcessorGlobal:parse_ROOM_CheckPwPunishOk", "i")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_TEAMWORLDBOSS, Protocol.TEAMWORLDBOSS_BeInvite, "ProtocolProcessorGlobal:parse_TEAMWORLDBOSS_BeInvite", "isisi")
...
function ProtocolProcessorGlobal:send_ROOM_SelectRoom(roomId, roomChannel, passWord )
...
function ProtocolProcessorGlobal:send_ZONE_GetBoxInfo( )
...
function ProtocolProcessorGlobal:send_ROOM_CheckPwPunish()
...
function ProtocolProcessorGlobal:parse_PLAYER_SynchronousWatchOk(battleId, playerIds, dataIds, masterIds, camp, hp, sp, CTB, postionX, postionY, angle, face, buffCount, buffId, buffPassCtb, buffUserId, explodePlayerId, explodeSkillId, explodePosNum, explodePosX, explodePosY, finishPercent, roundNum)
	-- battleId : 战斗id
	-- playerIds : 角色id
	...
	WZLog("ProtocolProcessorGlobal:parse_PLAYER_SynchronousWatchOk", roundNum, "\n设置当前属性",Serialize(VectorToTable(playerIds)), Serialize(VectorToTable(dataIds)), Serialize(VectorToTable(masterIds)), Serialize(VectorToTable(camp)), 
		...
		, "\n地图爆炸", Serialize(VectorToTable(explodePlayerId)), Serialize(VectorToTable(explodeSkillId)), Serialize(VectorToTable(explodePosNum)), Serialize(IntVectorToFloatTable(explodePosX)), Serialize(IntVectorToFloatTable(explodePosY)),finishPercent)
...
--@brief	进入婚礼现场（WEDDING_JoinWeddingOK = 23)
function ProtocolProcessorGlobal:parse_WEDDING_JoinWeddingOK(manName, womanName, playerId, playerName, playerHeadId, playerFaceId, playerBodyId, playerWingId, sex, level, marryType, weddingHallId, manFaceId, womanFaceId, password, vipLevel, playerHeadcolour, playerBodyColour, manHeadColour, womanHeadColour, manBodyColour, womanBodyColour, manFashionId, womanFashionId, manHeadId, womanHeadId,footmark)
	...
	-- womanHeadId : 新娘头
    --  footmark:足迹
	WZLog("ProtocolProcessorGlobal:parse_WEDDING_JoinWeddingOK ")
	SceneWeddingChurch:JoinWeddingOk(manName, womanName, VectorToTable(playerId), VectorToTable(playerName), VectorToTable(playerHeadId), VectorToTable(playerFaceId), VectorToTable(playerBodyId), VectorToTable(playerWingId), VectorToTable(sex), VectorToTable(level), marryType, weddingHallId,manFaceId,womanFaceId,password,VectorToTable(vipLevel),VectorToTable(playerHeadcolour),VectorToTable(playerBodyColour),manHeadColour,womanHeadColour,manBodyColour,womanBodyColour,manFashionId,womanFashionId,manHeadId,womanHeadId,VectorToTable(footmark))
end
...
--@brief	接收聊天信息(S->C)
function ProtocolProcessorGlobal:parse_CHAT_ReceiveMessage(channel, sendId, sendName, receiveId, receiveName, message, rtime,chatType,subType,vipLevel,sendFaceId,sendHeadId,sendSex,headScul,serviceId,headColor,senderLevel,bubbleId, playerTitle, playerPvpLevel)
    ...
    WZLog("playerInfo ",playerInfo.name)
    WZLog("ProtocolProcessorGlobal:parse_CHAT_ReceiveMessage ",bubbleId)
	...
	if (channel==CHANNEL_SYSTEM or channel==CHANNEL_WORLD or channel==CHANNEL_COLORCHAT ) and sendId ~= GlobalGame.g_tPlayerInfo.nPlayerId  then
		local mes = message
		...
		if channel==CHANNEL_COLORCHAT then
            ...
            if msg == mes then --世界副本邀请不进行滚动显示
                if not bInBlacklist then
                    WndSuona:showSuonaWithSendNameAndMessage(channel,sendName,mes,chType,subType)
                end
            end
	    else
            if not bInBlacklist then
	    	    WndSuona:showSuonaWithSendNameAndMessage(channel,sendName,mes,4,subType)
            end
		end
	end
	...
	WndChat:getReceiveMessageOK(channel, sendId, sendName, receiveId, receiveName, message, rtime, vipLevel,sendFaceId,sendHeadId,sendSex,headScul,serviceId,headColor,senderLevel,chatType,bubbleId, playerTitle, playerPvpLevel)
...
function ProtocolProcessorGlobal:parse_BOSSMAPROOM_BeInvite(roomId,playerName,mapId,password,roomChannel,assist)
	...
	if SceneRoom.m_root == nil and SceneBossRoom.m_root == nil and SceneBattle.m_root == nil and SceneBattleLoading.m_root == nil and GlobalGame.g_bIfInBattle == false and WndTeachOpenModule.m_root == nil and WndTeachTalk.m_root == nil and SceneKingMain.m_root == nil and not SceneHall:getMatchState() and not WndStrengthen.m_root then
        ...
        if judgeMapIdIsMarryCopy(mapId) then
			...
			SceneBossRoom:beInvited(roomId , playerName,mapId,password,roomChannel,assist)
		end
	end
end

--@brief	被邀请
function ProtocolProcessorGlobal:parse_ROOM_BeInvite(roomId, battleMode, playerName,passWord,roomChannel,schedule)
	-- roomId : 房间ID
	-- battleMode : 房间战斗模式
	-- playerName : 邀请人名称
	-- passWord : 房间密码
	...
	if WndInvited then
		...
		WndInvited:showInterface( ProtocolProcessorGlobal , ProtocolProcessorGlobal.send_ROOM_SelectRoom , roomId ,passWord, nil,string.format(tempStr,playerName,g_tRoomModeDesc[localSchedule]),playerName,nil,nil,roomChannel)
	end
end
...
--@brief    检测排位赛惩罚剩余时间（ROOM_CheckPwPunishOk = 104）
function ProtocolProcessorGlobal:parse_ROOM_CheckPwPunishOk(punishTime)
    -- punishTime : 惩罚剩余时间，小于0为不在惩罚时间内（秒）
    WZLog("ProtocolProcessorGlobal:parse_ROOM_CheckPwPunishOk ",punishTime)
    GlobalGame.g_pvpPunishTime = punishTime
    GlobalGame.g_pvpPunishTimeCurServiceT = SystemTime:getServerTime()
end

--@brief    回归系列活动状态（ACTIVITY_GetUserBackActivityStatusOk = 112）
function ProtocolProcessorGlobal:parse_ACTIVITY_GetUserBackActivityStatusOk(status)
    -- status : 状态(1:进行中;2:关闭)
    WZLog("ProtocolProcessorGlobal:parse_ACTIVITY_GetUserBackActivityStatusOk", status)
...
--@brief	发送副本列表
function ProtocolProcessorGlobal:parse_BOSSMAPROOM_SendBossMapList(resetTime, mapId, passTime, starLevel)
	-- resetTime : 重置次数
	-- mapId : 地图id
	-- passTime : 已挑战次数
	-- starLevel : 副本星级（未打过的副本星级为0）
	WZLog("ProtocolProcessorGlobal:parse_BOSSMAPROOM_SendBossMapListaa")
    CacheCenter:setMultiCopyData(resetTime, VectorToTable(mapId), VectorToTable(passTime), VectorToTable(starLevel))
end
...
--@brief	获取娱乐赛信息结果（ROOM_GetFunnyMatchInfoOk = 96）
function ProtocolProcessorGlobal:parse_ROOM_GetFunnyMatchInfoOk(matchType, activityStatus, dayOfWeek)
	...
	ScenePvpAmuse:setOpenState(VectorToTable(matchType), VectorToTable(activityStatus), VectorToTable(dayOfWeek))
end
...
--@brief    获取宝箱信息（ZONE_GetBoxInfoOk = 6）
function ProtocolProcessorGlobal:parse_ZONE_GetBoxInfoOk(index, boxId, status, countdown)
    -- index : 下标
    -- boxId : 宝箱id
    -- status : 状态
    -- countdown : 倒计时
    WZLog("ProtocolProcessorGlobal:parse_ZONE_GetBoxInfoOk",countdown)
    if countdown > 0 then
...
function ProtocolProcessorGlobal:parse_TEAMWORLDBOSS_BeInvite(roomId, playerName, mapId, password, roomChannel)
    -- roomId : 房间ID
    -- playerName : 玩家名
    -- mapId : 地图
    -- password : 房间密码
    ...
    SceneWorldTeamBossRoom:beInvited(roomId , playerName, mapId, password, roomChannel)
end
...
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorGlobal:send_ZONE_GetBoxInfo_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorGlobal:send_ZONE_GetBoxInfo_ErrorProcess")
