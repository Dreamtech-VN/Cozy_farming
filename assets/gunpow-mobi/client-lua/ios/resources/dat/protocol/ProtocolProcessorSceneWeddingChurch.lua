...
function ProtocolProcessorSceneWeddingChurch:regAll()
   ...
   self:regProtocolCallbackFunction( Protocol.MAIN_WEDDING, Protocol.WEDDING_Operation, "ProtocolProcessorSceneWeddingChurch:send_WEDDING_Operation_ErrorProcess", "is" )
	...
	self:regProtocolCallbackFunction( Protocol.MAIN_WEDDING, Protocol.WEDDING_RefreshWedding, "ProtocolProcessorSceneWeddingChurch:parse_WEDDING_RefreshWedding", "isiiiitniii")
...
--@brief	刷新婚礼现场（WEDDING_RefreshWedding = 36）
function ProtocolProcessorSceneWeddingChurch:parse_WEDDING_RefreshWedding(playerId, playerName, playerHeadId, playerFaceId, playerBodyId, playerWingId, sex, level,headColor,bodyColor,footmark)
	-- playerId : 来宾玩家id
	-- playerName : 来宾玩家昵称
	...
	SceneWeddingChurch:RefreshWedding(playerId, playerName, playerHeadId, playerFaceId,playerBodyId, playerWingId,sex,level,headColor,bodyColor,footmark)
end
