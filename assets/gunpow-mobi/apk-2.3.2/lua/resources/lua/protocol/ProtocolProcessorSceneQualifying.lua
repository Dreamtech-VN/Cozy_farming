...
function ProtocolProcessorSceneQualifying:regAll()
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_MakePairOk, "ProtocolProcessorSceneQualifying:parse_ROOM_MakePairOk", "iiiiiivivivsvsvsvsvivivivivivivivivivivivivivivivivivivivivivivivivsvivivsvivivivivivivivsvsvnvivivbviivivsvivivsvivsvsvsvivivivi")
...
function ProtocolProcessorSceneQualifying:parse_RANKMATCH_HistoryRankOK(playerId, playerName, playerSex, playerHeadId, playerFaceId, playerLevel,
	...
	if WndPvpRankList.m_root then
		WndPvpRankList:setHistoryData(data)
	end
end
