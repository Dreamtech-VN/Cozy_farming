...
function ProtocolProcessorStore:regAll()
	...
	self:regProtocolCallbackFunction( Protocol.MAIN_GUILD, Protocol.GUILD_GetGuildStoreOk, "ProtocolProcessorStore:parse_GUILD_GetGuildStoreOk", "viviivi")
	...
	self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_GetBlackMarketInfoOk, "ProtocolProcessorStore:parse_MALL_GetBlackMarketInfoOk", "bivivivivivivivi")
    ...
    self:regProtocolCallbackFunction( Protocol.MAIN_TRATE, Protocol.PRAY_GetPrayShopOk, "ProtocolProcessorStore:parse_PRAY_GetPrayShopOk", "vivsvsvsiivi")
    ...
    --@brief    获取助战商品列表（ROOM_GetAssistStoreOk = 108）
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM , Protocol.ROOM_GetAssistStoreOk, "ProtocolProcessorStore:parse_ROOM_GetAssistStoreOk", "vivsvsviil")
    --@brief    获取助战商品列表（ROOM_GetAssistStore = 107）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM , Protocol.ROOM_GetAssistStore, "ProtocolProcessorStore:send_ROOM_GetAssistStore_ErrorProcess", "is" )
    --@brief    购买助战商店物品（ROOM_BuyAssistStore = 110））错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_BuyAssistStore, "ProtocolProcessorStore:send_ROOM_BuyAssistStore_ErrorProcess", "is" )
    --@brief    购买助战商店物品（ROOM_BuyAssistStoreOk = 111）
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_BuyAssistStoreOk, "ProtocolProcessorStore:parse_ROOM_BuyAssistStoreOk", " ")
    --@brief    刷新助战商店（ROOM_RefreshAssistStore = 109）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_ROOM, Protocol.ROOM_RefreshAssistStore, "ProtocolProcessorStore:send_ROOM_RefreshAssistStore_ErrorProcess", "is" )

    --@brief 召唤商店
    --      获取召唤商店(PLAYER2_GetCallStoreInfo = 31)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_GetCallStoreInfo, "ProtocolProcessorStore:send_PLAYER2_GetCallStoreInfo_ErrorProcess", "is")
    --      获取召唤商店成功(PLAYER2_GetCallStoreInfoOk = 32)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_GetCallStoreInfoOk, "ProtocolProcessorStore:parse_PLAYER2_GetCallStoreInfoOk", "vivsvsviii")
    --      刷新召唤商店(PLAYER2_ReCallStoreInfo = 33)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_ReCallStoreInfo, "ProtocolProcessorStore:send_PLAYER2_ReCallStoreInfo_ErrorProcess", "is")
    --      购买召唤商店物品(PLAYER2_BuyDrawStore = 34)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyDrawStore, "ProtocolProcessorStore:send_PLAYER2_BuyDrawStore_ErrorProcess", "is")
    --      购买召唤商店物品成功(PLAYER2_BuyDrawStore = 35)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyDrawStoreOk, "ProtocolProcessorStore:parse_PLAYER2_BuyDrawStoreOk", "")

    --能源商店
    --@brief    能源商店【167+】（PLAYER2_BreachLevelStore = 44）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BreachLevelStore, "ProtocolProcessorStore:send_PLAYER2_BreachLevelStore_ErrorProcess", "is")
    --@brief    购买能源晶石【167+】（PLAYER2_BuyBreachLevel = 46）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyBreachLevel, "ProtocolProcessorStore:send_PLAYER2_BuyBreachLevel_ErrorProcess", "is")
    --@brief    能源商店【167+】（PLAYER2_BreachLevelStoreOk = 45）
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BreachLevelStoreOk, "ProtocolProcessorStore:parse_PLAYER2_BreachLevelStoreOk", "iiiii")
    --@brief    购买能源晶石【167+】（PLAYER2_BuyBreachLevelOk = 47）
    self:regProtocolCallbackFunction( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyBreachLevelOk, "ProtocolProcessorStore:parse_PLAYER2_BuyBreachLevelOk", "ti")

    -- 41粉丝商店,42VIP商店,43鲜花商店,44排位商店
    --@brief    获取商城物品信息（MALL_GetShopNewGoods = 59）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_GetShopNewGoods, "ProtocolProcessorStore:send_MALL_GetShopNewGoods_ErrorProcess", "is" )
    --@brief    获取商城物品信息（MALL_GetShopNewGoodsOK = 60）
    self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_GetShopNewGoodsOK, "ProtocolProcessorStore:parse_MALL_GetShopNewGoodsOK", "ivivivsvsvii")
    --@brief    新商城-刷新物品（MALL_RefreshShopNewGoods = 61）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_RefreshShopNewGoods, "ProtocolProcessorStore:send_MALL_RefreshShopNewGoods_ErrorProcess", "is" )
    --@brief    新商城-购买物品（MALL_BuyShopNewGoods = 62）错误处理(S->C)
    self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_BuyShopNewGoods, "ProtocolProcessorStore:send_MALL_BuyShopNewGoods_ErrorProcess", "is" )
    --@brief    新商城-购买物品（MALL_BuyShopNewGoodsOK = 63）
    self:regProtocolCallbackFunction( Protocol.MAIN_MALL, Protocol.MALL_BuyShopNewGoodsOK, "ProtocolProcessorStore:parse_MALL_BuyShopNewGoodsOK", "")
end
...
--@brief    获取助战商品列表（ROOM_GetAssistStore = 107）
function ProtocolProcessorStore:send_ROOM_GetAssistStore()
    WZLog("send_ROOM_GetAssistStore")
    local sender = Protocol:getSender( Protocol.MAIN_ROOM , Protocol.ROOM_GetAssistStore )
    if sender==nil then WZLog("sender == nil") return end

    SendProtocol(sender,false) --true:showLoading
end

--@brief    购买助战商店物品（ROOM_BuyAssistStore = 110）
function ProtocolProcessorStore:send_ROOM_BuyAssistStore(storeId )
    WZLog("send_ROOM_BuyAssistStore")
    local sender = Protocol:getSender( Protocol.MAIN_ROOM, Protocol.ROOM_BuyAssistStore )
    if sender==nil then WZLog("sender == nil") return end
...
--@brief    刷新助战商店（ROOM_RefreshAssistStore = 109）
function ProtocolProcessorStore:send_ROOM_RefreshAssistStore()
    WZLog("send_ROOM_RefreshAssistStore")
    local sender = Protocol:getSender( Protocol.MAIN_ROOM, Protocol.ROOM_RefreshAssistStore )
    if sender==nil then WZLog("sender == nil") return end
    SendProtocol(sender,false) --true:showLoading
end

--@brief    获取召唤商店信息
function ProtocolProcessorStore:send_PLAYER2_GetCallStoreInfo()
    -- body
    WZLog("send_PLAYER2_GetCallStoreInfo")
    local sender = Protocol:getSender( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_GetCallStoreInfo)
    if sender == nil then WZLog("sender == nil") return end
    SendProtocol(sender,false)
end

--@brief    刷新召唤商店
function ProtocolProcessorStore:send_PLAYER2_ReCallStoreInfo()
    -- body
    WZLog("send_PLAYER2_ReCallStoreInfo")
    local sender = Protocol:getSender( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_ReCallStoreInfo)
    if sender == nil then WZLog("sender == nil") return end
    SendProtocol(sender,false)
end

--@brief    购买召唤商店物品
function ProtocolProcessorStore:send_PLAYER2_BuyDrawStore(storeId)
    -- body
    WZLog("send_PLAYER2_BuyDrawStore")
    local sender = Protocol:getSender( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyDrawStore)
    if sender==nil then WZLog("sender == nil") return end
...
--@brief    能源商店【167+】（PLAYER2_BreachLevelStore = 44）
function ProtocolProcessorStore:send_PLAYER2_BreachLevelStore()
    WZLog("send_PLAYER2_BreachLevelStore")
    local sender = Protocol:getSender( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BreachLevelStore )
    if sender==nil then WZLog("sender == nil") return end

    SendProtocol(sender,false) --true:showLoading
end

--@brief    购买能源晶石【167+】（PLAYER2_BuyBreachLevel = 46）
function ProtocolProcessorStore:send_PLAYER2_BuyBreachLevel(buyNum, costId)
    WZLog("send_PLAYER2_BuyBreachLevel")
    local sender = Protocol:getSender( Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyBreachLevel )
    if sender==nil then WZLog("sender == nil") return end

    sender:writeInt(buyNum) -- 购买数量
    sender:writeInt(costId) -- 货币ID
    SendProtocol(sender,false) --true:showLoading
end

--@brief    获取商城物品信息（MALL_GetShopNewGoods = 59）
function ProtocolProcessorStore:send_MALL_GetShopNewGoods(shopType)
    WZLog("send_MALL_GetShopNewGoods", shopType)
    local sender = Protocol:getSender( Protocol.MAIN_MALL, Protocol.MALL_GetShopNewGoods )
    if sender==nil then WZLog("sender == nil") return end

    sender:writeInt( shopType )  
    SendProtocol(sender,false) --true:showLoading
end

--@brief    新商城-刷新物品（MALL_RefreshShopNewGoods = 61）
function ProtocolProcessorStore:send_MALL_RefreshShopNewGoods(shopType)
    WZLog("send_MALL_RefreshShopNewGoods", shopType)
    local sender = Protocol:getSender( Protocol.MAIN_MALL, Protocol.MALL_RefreshShopNewGoods )
    if sender==nil then WZLog("sender == nil") return end
...
--@brief    新商城-购买物品（MALL_BuyShopNewGoods = 62）
function ProtocolProcessorStore:send_MALL_BuyShopNewGoods(shopType, id, num)
    WZLog("send_MALL_BuyShopNewGoods", shopType, id, num)
    local sender = Protocol:getSender( Protocol.MAIN_MALL, Protocol.MALL_BuyShopNewGoods )
    if sender==nil then WZLog("sender == nil") return end
...
--@brief	获取公会商店（GUILD_GetGuildStoreOk = 45）
function ProtocolProcessorStore:parse_GUILD_GetGuildStoreOk(itemId, itemNum, guildLevel, limitNum)
	-- itemId	int[]	商品ID
    -- itemNum	int[]	商品数量
    -- guildLevel	int	公会等级
    -- limitNum	int[]	可购买数量
	WZLog("ProtocolProcessorStore:parse_GUILD_GetGuildStoreOk",Serialize(VectorToTable(itemId)),Serialize(VectorToTable(itemNum)), guildLevel,Serialize(VectorToTable(limitNum)))
	if not WndStore or WndStore.m_root == nil then return end
	itemId = VectorToTable(itemId)
	itemNum = VectorToTable(itemNum)
    limitNum = VectorToTable(limitNum)
    local shopList = {}
	for i=1,#itemId do
		local tempTable = {}
...
function ProtocolProcessorStore:parse_GUILD_BuyGuildStoreOk(status)
	...
	if status == 0 or status == 3 then
		WndStore:storeItemBuySuccess(status)
	else
...
--@brief	获取黑店信息结果（MALL_GetBlackMarketInfoOk = 21）
function ProtocolProcessorStore:parse_MALL_GetBlackMarketInfoOk(isOpen, leftSecond, id, itemId, gainCount, leftBuyTime, costItemId, costCount, disCount)
	-- isOpen : 黑店是否开启
	-- leftSecond : 黑店剩余时间(s)
	-- itemId : 商品id
	-- gainCount : 商品数目 
    ...
    disCount = VectorToTable(disCount)
	local tempDataList = {}
	for i=1,#itemId do
		local tempData = {}
		tempData.id = id[i]
...
--@brief    获取祈福商店信息结果（PRAY_GetPrayShopOk = 18）
function ProtocolProcessorStore:parse_PRAY_GetPrayShopOk(shopId, store, name, cost, num,reTime,status)
    -- vivsvsvsiivi
    -- shopId : 商品id
    -- store : 商品信息
    -- name : 商品名称
    -- cost : 购买商品消耗
    WZLog("ProtocolProcessorStore:parse_PRAY_GetPrayShopOk",Serialize(VectorToTable(shopId)), num,reTime)
    if not WndStore or WndStore.m_root == nil then return end
    local shopItemList = {}

	for i = 0, shopId:size() - 1 do
		local itemId = SplitStringToTable(store:get(i))
        WZLog("祈福商店",Serialize(itemId))
	...
	WZLog("祈福商店数据",Serialize(shopItemList))
	WndStore:setBlessShopData(shopItemList,num,reTime)
end
...
function ProtocolProcessorStore:parse_PRAY_GetShopOk(buyPrayId, prayId, exp)
    ...
    -- prayId : 购买祈福珠Id
    -- exp : 购买祈福珠经验
    WZLog("ProtocolProcessorStore:parse_PRAY_GetShopOk",Serialize(buyPrayId,Serialize(prayId),Serialize(exp)))
     if not WndStore or WndStore.m_root == nil then return end
    WndStore:storeBlessBuySuccess()
    -- WndBlessBag:resetBagList(buyPrayId, prayId, exp)
    if WndBlessBag.m_root then
        WndBlessBag:sendPRAYProtocol()
    end
end
...
function ProtocolProcessorStore:parse_CARD_GetCardMesOk(itemId, level, num, shopId, shopItem, shopPrice, shopRebate, shopStatus, refreshCount,lookItemId)
    ...
    -- refreshCount : 手动刷新次数
    -- lookItemId : 查看过的卡牌ID
    WZLog("ProtocolProcessorStore:parse_CARD_GetCardMesOk ",Serialize(VectorToTable(shopRebate)))
...
--@brief    获取助战商品列表（ROOM_GetAssistStoreOk = 108）
function ProtocolProcessorStore:parse_ROOM_GetAssistStoreOk(storeId, store, cost, status, refreshCount, nextRefreshTime)
    -- storeId : 商店ID（购买时使用该ID）
    -- store : 商品,格式[100,2]
    -- cost : 购买消耗，格式[7,100]
    -- status : 状态0未买过，1已买过了
    -- refreshCount : 刷新次数
    -- nextRefreshTime : 下次自动刷新时间(秒数)
    WZLog("ProtocolProcessorStore:parse_ROOM_GetAssistStoreOk")
    if not WndStore or WndStore.m_root == nil then return end
    local shopInfo = {}
    for i = 0, storeId:size()-1 do
        local temp = nil
    ...
    WndStore:setAssistData(shopInfo,refreshCount,nextRefreshTime)
    WZLog("--------------------------get Assist shop list-------------------------------")
end

--@brief    购买助战商店物品（ROOM_BuyAssistStoreOk = 111）
function ProtocolProcessorStore:parse_ROOM_BuyAssistStoreOk()
    WZLog("ProtocolProcessorStore:parse_ROOM_BuyAssistStoreOk")
    if not WndStore or WndStore.m_root == nil then return end
...
--brief     获取召唤商店信息
function ProtocolProcessorStore:parse_PLAYER2_GetCallStoreInfoOk(storeId,store,cost,status,refreshCount,nextRefreshTime)
    -- body
    WZLog("ProtocolProcessorStore:PLAYER2_GetCallStoreInfoOk",Serialize(VectorToTable(storeId)))
   if not WndStore or WndStore.m_root == nil then return end
    local shopInfo = {}
    for i = 0, storeId:size()-1 do
        local temp = nil
    ...
    WndStore:setLotteryData(shopInfo,refreshCount,nextRefreshTime)
    WZLog("--------------------------get Lottery shop list-------------------------------")
end

--@brief    购买召唤商店物品成功
function ProtocolProcessorStore:parse_PLAYER2_BuyDrawStoreOk()
    -- body
    WZLog("ProtocolProcessorStore:parse_PLAYER2_BuyDrawStoreOk")
    if not WndStore or WndStore.m_root == nil then return end
...
--@brief    能源商店【167+】（PLAYER2_BreachLevelStoreOk = 45）
function ProtocolProcessorStore:parse_PLAYER2_BreachLevelStoreOk(stockNum, goodsId, costId, costNum, discount)
    -- stockNum : 剩余库存数量
    -- goodsId : 商品ID
    -- costId : 货币ID
    -- costNum : 最终价
    -- discount : 折扣
    WZLog("ProtocolProcessorStore:parse_PLAYER2_BreachLevelStoreOk", stockNum, goodsId, costId, costNum, discount)

    WndStore:setEnergyData(goodsId, stockNum, costId, costNum, discount)
end

--@brief    购买能源晶石【167+】（PLAYER2_BuyBreachLevelOk = 47）
function ProtocolProcessorStore:parse_PLAYER2_BuyBreachLevelOk(result, stockNum)
    -- result : 购买结果【0=成功|1=货币不足|2=库存不足|3=货币种类错误】
    -- stockNum : 剩余库存数量
    WZLog("ProtocolProcessorStore:parse_PLAYER2_BuyBreachLevelOk")

    WndStore:buyEnergyOK(result, stockNum)
end

--@brief   获取商城物品信息（MALL_GetShopNewGoodsOK = 60）
function ProtocolProcessorStore:parse_MALL_GetShopNewGoodsOK(shopType, id, buyLimit, goodsStr, costItemStr, buyNum, totalRefreshTimes)
    -- shopType : buyLimit
    -- id : 唯一标志
    -- buyLimit : 商品限购次数
    -- goodsStr : 商品物品的:[物品id,数量]
    -- costItemStr : 消耗物品的[id,数量] 
    -- buyNum : 商品购买次数
    -- totalRefreshTimes : 总的刷新次数 

    WZLog("ProtocolProcessorStore:parse_MALL_GetShopNewGoodsOK", 
        "\n shopType =",Serialize(VectorToTable(shopType)), 
        "\n id =",Serialize(VectorToTable(id)), 
        "\n buyLimit =",Serialize(VectorToTable(buyLimit)), 
        "\n goodsStr =",Serialize(VectorToTable(goodsStr)), 
        "\n costItemStr =",Serialize(VectorToTable(costItemStr)), 
        "\n buyNum =",Serialize(VectorToTable(buyNum)), 
        "\n totalRefreshTimes =",Serialize(VectorToTable(totalRefreshTimes)))

    WndStore:setShopData(shopType, VectorToTable(id), VectorToTable(buyLimit), VectorToTable(goodsStr), VectorToTable(costItemStr), VectorToTable(buyNum), totalRefreshTimes)
end

--@brief    新商城-购买物品（MALL_BuyShopNewGoodsOK = 63）
function ProtocolProcessorStore:parse_MALL_BuyShopNewGoodsOK()
    WZLog("ProtocolProcessorStore:parse_MALL_BuyShopNewGoodsOK")
    if not WndStore or WndStore.m_root == nil then return end
    WndStore:storeItemBuySuccess()
end
...
--@brief    获取助战商品列表（ROOM_GetAssistStore = 107）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_ROOM_GetAssistStore_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_ROOM_GetAssistStore_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_ROOM , Protocol.ROOM_GetAssistStore, nFlag, sMessage)
end

--@brief    购买助战商店物品（ROOM_BuyAssistStore = 110）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_ROOM_BuyAssistStore_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_ROOM_BuyAssistStore_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_ROOM, Protocol.ROOM_BuyAssistStore, nFlag, sMessage)
end

--@brief    刷新助战商店（ROOM_RefreshAssistStore = 109）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_ROOM_RefreshAssistStore_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_ROOM_RefreshAssistStore_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_ROOM, Protocol.ROOM_RefreshAssistStore, nFlag, sMessage)
end

--@brief    获取召喚商品列表（PLAYER2_GetCallStoreInfo = 31）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_PLAYER2_GetCallStoreInfo_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_PLAYER2_GetCallStoreInfo_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_PLAYER2 , Protocol.PLAYER2_GetCallStoreInfo, nFlag, sMessage)
end

--@brief    购买召喚商店物品（PLAYER2_BuyDrawStore = 34）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_PLAYER2_BuyDrawStore_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_PLAYER2_BuyDrawStore_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyDrawStore, nFlag, sMessage)
end

--@brief    刷新召唤商店（PLAYER2_ReCallStoreInfo = 33）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_PLAYER2_ReCallStoreInfo_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_PLAYER2_ReCallStoreInfo_ErrorProcess")
    WndStore:closeLoadingB()
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_PLAYER2, Protocol.PLAYER2_ReCallStoreInfo, nFlag, sMessage)
end

--@brief    能源商店【167+】（PLAYER2_BreachLevelStore = 44）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_PLAYER2_BreachLevelStore_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:parse_PLAYER2_BreachLevelStore_ErrorProcess")
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BreachLevelStore, nflag, sMessage)
end

--@brief    购买能源晶石【167+】（PLAYER2_BuyBreachLevel = 46）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_PLAYER2_BuyBreachLevel_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:parse_PLAYER2_BuyBreachLevel_ErrorProcess")
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_PLAYER2, Protocol.PLAYER2_BuyBreachLevel, nflag, sMessage)
end

--@brief    获取商城物品信息（MALL_GetShopNewGoods = 59）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_MALL_GetShopNewGoods_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_MALL_GetShopNewGoods_ErrorProcess")
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_MALL, Protocol.MALL_GetShopNewGoods, nflag, sMessage)
end

--@brief    新商城-刷新物品（MALL_RefreshShopNewGoods = 61）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_MALL_RefreshShopNewGoods_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_MALL_RefreshShopNewGoods_ErrorProcess")
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_MALL, Protocol.MALL_RefreshShopNewGoods, nflag, sMessage)
end

--@brief    新商城-购买物品（MALL_BuyShopNewGoods = 62）错误处理函数(S->C)
--@param    nFlag:标志位
--@param    sMessage:错误信息
--@note 在此对协议错误进行相应处理
function ProtocolProcessorStore:send_MALL_BuyShopNewGoods_ErrorProcess(nFlag, sMessage)
    WZLog("ProtocolProcessorStore:send_MALL_BuyShopNewGoods_ErrorProcess")
    ProtocolErrorProcessor:errorProcess(Protocol.MAIN_MALL, Protocol.MALL_BuyShopNewGoods, nflag, sMessage)
end
