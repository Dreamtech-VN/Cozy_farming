...
function CellCharmReward:_update(  )
	...
	WZLog("是否显示公会奖励",WndCharmSpace.m_nInterfaceType)
	if self.tag == 1 and WndCharmSpace.m_nInterfaceType ~= 2 and WndCharmSpace.m_nInterfaceType ~= 4 then
	...
	if WndCharmSpace.m_nInterfaceType == 1 then 
		GetElement(self.m_root,"con7_CellCharmReward",WZUIContainer):setVisible(false)
	end
