...
function SceneCreateActor:_init()
    ...
    self.autoCreateTime = 0     -- qq大厅自动创角倒计时
    self.autoCreateColdTime = 0 -- qq大厅自动创角无操作多少秒则开始倒计时
    self.preActorName = nil     -- qq大厅自动创角记录角色名是否发生变化，无变化限定时长则开始倒计时
    self.isCallOnBtnEnterGameClicked = false    -- qq大厅是否调用了进入游戏方法
end
