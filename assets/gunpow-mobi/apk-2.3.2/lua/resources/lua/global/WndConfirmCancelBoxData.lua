...
function WndConfirmCancelBox:_msgCallBack(nResType)
	...
	if self.m_tMsgData.fCallbackFunc then
		...
		if self.m_tMsgData.tCallbackLuaObj then
			self.m_tMsgData.fCallbackFunc(self.m_tMsgData.tCallbackLuaObj, self.m_tMsgData.nId, nResType, self.m_tMsgData.costItemId)
		else
			self.m_tMsgData.fCallbackFunc(self.m_tMsgData.nId, nResType, self.m_tMsgData.costItemId)
		end
	end
end
