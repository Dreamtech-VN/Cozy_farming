...
function WndMsgConfirmBox:_adaptLanguage_ug()
    WZUILabelTTF:luaTo(self.m_root:getChildElement("txtNotAtt_WndMsgConfirmBox")):setDimensions(GlobalMethod:CCSize(240))
    local txtSellConfirm = GetElement(self.m_root, "txtSellConfirm_WndMsgConfirmBox", WZUILabelTTF)
    txtSellConfirm:setScale(0.7)
    txtSellConfirm:setDimensions(GlobalMethod:CCSize(440))
    txtSellConfirm:setRelativePosition(GlobalMethod:ccp(0.5,0.71))
