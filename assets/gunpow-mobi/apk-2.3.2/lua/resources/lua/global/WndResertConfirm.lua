...
function WndResertConfirm:_adaptLanguage_ug(  )
    local txtTemp2 = GetElement(self.m_root,"txtTemp2_WndResertConfirm",WZUILabelTTF)
    txtTemp2:setScale(0.7)
    txtTemp2:setRelativePosition(GlobalMethod:ccp(0.231861,0.713953))
    local txtCostCount = GetElement(self.m_root,"txtCostCount_WndResertConfirm",WZUILabelTTF)
    txtCostCount:setScale(0.7)
    txtCostCount:setAnchorPoint(GlobalMethod:ccp(0.5,0.5))
    txtCostCount:setRelativePosition(GlobalMethod:ccp(0.477869,0.713953))
    local imgDiamond = GetElement(self.m_root,"imgCostIcon_WndResertConfirm",WZUIImage)
    imgDiamond:setScale(0.4)
    imgDiamond:setRelativePosition(GlobalMethod:ccp(0.549226,0.713953))
    local txtResert = GetElement(self.m_root,"txtResert_WndResertConfirm",WZUILabelTTF)
    txtResert:setScale(0.7)
    txtResert:setRelativePosition(GlobalMethod:ccp(0.786108,0.713953))

    local txtResertRemind = GetElement(self.m_root,"txtResertRemind_WndResertConfim",WZUIFreeTextBox)
    txtResertRemind:setScale(0.7)
    txtResertRemind:setMaxWidth(480)
    local txtResetTips2 = GetElement(self.m_root,"txtResertTips2_WndResertConfirm",WZUILabelTTF)
    txtResetTips2:setScale(0.7)
    txtResetTips2:setDimensions(GlobalMethod:CCSize(480,0))

    GetElement(self.m_root,"txtConfirm1_WndResertConfirm",WZUILabelTTF):setScale(0.7)
    GetElement(self.m_root,"txtConfirm2_WndResertConfirm",WZUILabelTTF):setScale(0.7)
end
-------------------------------------私有方法模块End----------------------------------------
