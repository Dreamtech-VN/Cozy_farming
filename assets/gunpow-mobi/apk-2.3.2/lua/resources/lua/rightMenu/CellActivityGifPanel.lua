...
function CellActivityGifPanel:_setBuyTimes( BuyTimes )
    ...
    if BuyTimes == 0 then
        local btnGetReward_CellActivityGifPanel = GetElement(self.m_root, "btnGetReward_CellActivityGifPanel", WZUIButton)
        if btnGetReward_CellActivityGifPanel then
	        btnGetReward_CellActivityGifPanel:setTouchEnable(false)
	    end
    end
end
