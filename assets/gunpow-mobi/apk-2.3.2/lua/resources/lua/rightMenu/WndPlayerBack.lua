...
function WndPlayerBack:_adaptLanguage_es(  )
    local txtBtnReward = GetElement(self.m_root, "txtBtnReward_WndPlayerBack", WZUILabelTTF)
    txtBtnReward:setScale(0.7)
    txtBtnReward:setDimensions(GlobalMethod:CCSize(170))
end
-------------------------------------语言适配End--------------------------------------------