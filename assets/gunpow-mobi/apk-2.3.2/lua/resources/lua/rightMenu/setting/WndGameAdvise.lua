...
function WndGameAdvise:onBtnType( element)
    ...
    -- local imgLight = GetElement(self.m_root,"imgLight"..tag.."_WndGameAdvise",WZUIContainer)
...
function WndGameAdvise:onHeroWeb( element)
    ...
    if appVersion > "3.0.6" and platForm == 2 then
        WZLog("WndGameAdvise:onHeroWeb appVersion > 3.0.6")
        showUserAgreement(5)
    else
