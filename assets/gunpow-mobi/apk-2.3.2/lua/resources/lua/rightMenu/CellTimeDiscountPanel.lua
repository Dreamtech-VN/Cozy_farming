...
function CellTimeDiscountPanel:showWindow( ... )
    ...
    if self.m_nActivityType == g_tGameActivityTypes.ACTIVITY_NEWSERVER_TIMEDISCOUNT then 
        GetElement(self.m_root, "imgBK_CellTimeDiscountPanel", WZUIImage):setFile("ui/newActivity/activity_pic_hd_15.png")
    end
    self:_showTime()
    self:_showGoods()
...
function CellTimeDiscountPanel:_adaptLanguage_vn(  )
    GetElement(self.m_root,"txtTime_CellTimeDiscountPanel",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.365,0.5))
end
