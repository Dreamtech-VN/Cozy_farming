...
function WndCityBottomBar:_init()
    ...
    self.m_nCountdownTime = 0          --删除角色倒计时
    self.m_conDownloadDia = nil 
    self.m_nAttDiaShowTime = 0          --下载提示气泡显示时间
    self.m_nodeBtnDown = nil 
end
...
function WndCityBottomBar:_unInit()
    ...
    self.m_nCountdownTime = 0          --删除角色倒计时
    self.m_conDownloadDia = nil 
    self.m_nAttDiaShowTime = nil          --下载提示气泡显示时间
    self.m_nodeBtnDown = nil 
end
...
--@brief    下载完成回调
function WndCityBottomBar:_downloadFinish()
