...
-------------------------------------语言适配Begin--------------------------------------
function CellTrainingRewardList:_adaptLanguage_ug(  )
    for i = 1, 3 do
        local txtChallenge = GetElement(self.m_root, "txtChallenge"..i.."_CellTrainingRewardList", WZUILabelTTF)
        txtChallenge:setScale(0.7)
        txtChallenge:setDimensions(GlobalMethod:CCSize(150))
    end
end
