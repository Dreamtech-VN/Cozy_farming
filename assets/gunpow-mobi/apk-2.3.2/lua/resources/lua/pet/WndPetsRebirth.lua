...
function WndPetsRebirth:playAttackAni()
  local conPet = GetElement(self.m_root,"conPetImage_WndPetsRebirth",WZUIContainer)
...
function WndPetsRebirth:_updateWaitAni(element)
...
--@breif 显示宠物战力
function WndPetsRebirth:showFight()
  local fight = WndPets:getCurPetFight()
  local qualification = WndPets:getCurPetQualification()

  local txtFight = GetElement(self.m_root,"txtFight_WndPetsRebirth",WZUILabelTTF)
  CCNodePropertySetter:setValue(txtFight, "skewX", 10)
  local ftbFight = GetElement(self.m_root,"ftbFight_WndPetsRebirth",WZUIFreeTextBox)
  ...
  local txtPetQualification = GetElement(self.m_root,"txtPetQualification_WndPetsRebirth",WZUILabelTTF)
  txtPetQualification:setText(LocalStrings.PETINTELLIGENCE..qualification)
end

function WndPetsRebirth:onShowAttribute(element)
...
function WndPetsRebirth:_adaptLanguage_ug(  )
  GetElement(self.m_root,"imgSpendType_WndPetsRebirth",WZUIImage):setScale(0.6)
  local txtSpendSum = GetElement(self.m_root,"txtSpendSum_WndPetsRebirth",WZUILabelTTF)
  txtSpendSum:setScale(0.7)
  txtSpendSum:setRelativePosition(GlobalMethod:ccp(0.3,0.5))
  local txtPetRebirthe = GetElement(self.m_root,"txtPetRebirthe_WndPetsRebirth",WZUILabelTTF)
  txtPetRebirthe:setDimensions(GlobalMethod:CCSize(100,0))
  txtPetRebirthe:setScale(0.7)
  txtPetRebirthe:setRelativePosition(GlobalMethod:ccp(0.731577,0.5))

  GetElement(self.m_root,"txtLv1_WndPetsRebirth",WZUILabelTTF):setScale(0.7)
  local txtName1 = GetElement(self.m_root,"txtName1_WndPetsRebirth",WZUILabelTTF)
  txtName1:setRelativePosition(GlobalMethod:ccp(0.23,0.5))
  txtName1:setScale(0.7)
  GetElement(self.m_root,"txtName2_WndPetsRebirth",WZUILabelTTF):setScale(0.7)
  
  local txtPetRebirth = GetElement(self.m_root,"txtPetRebirth_WndPetsRebirth",WZUILabelTTF)
  txtPetRebirth:setScale(0.8)
  txtPetRebirth:setRelativePosition(GlobalMethod:ccp(0.5,0.7))
  local txtRebirthExplain = GetElement(self.m_root,"txtRebirthExplain_WndPetsRebirth",WZUILabelTTF)
  txtRebirthExplain:setRelativePosition(GlobalMethod:ccp(0.020564,0.436728))
  txtRebirthExplain:setDimensions(GlobalMethod:CCSize(580))
  txtRebirthExplain:setScale(0.6)
end
