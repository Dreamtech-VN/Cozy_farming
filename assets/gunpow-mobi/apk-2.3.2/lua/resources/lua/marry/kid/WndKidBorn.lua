...
function WndKidBorn:setGoodsNum()
	...
	local nHaveNum = CacheCenter:getPlayerHomeItemCountById(tonumber(id))
	local sFormat = [[<T C="127,70,26" S="20" P="1">%s%s:%d</T>]]
	...
	nHaveNum = CacheCenter:getPlayerHomeItemCountById(tonumber(id))
...
function WndKidBorn:_adaptLanguage_ug( )
	GetElement(self.m_root, "txtTitle1_WndKidBorn", WZUILabelTTF):setScale(0.6)
	GetElement(self.m_root, "txtTitle2_WndKidBorn", WZUILabelTTF):setScale(0.8)
