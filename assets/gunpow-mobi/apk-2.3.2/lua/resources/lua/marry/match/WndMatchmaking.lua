...
function WndMatchmaking:setNextBtnText(text, style)
	...
	if txtNextWord then
		...
		if style == 1 then
			txtNextWord:setColor(ccc3(255,255,255))
			txtNextWord:setStrokeColor(ccc3(79,60,48))
		elseif style == 2 then
			txtNextWord:setColor(ccc3(255,250,236))
			txtNextWord:setStrokeColor(ccc3(0,108,3))
		end
	end
end
...
function WndMatchmaking:_timeCount(element)
	...
	if self.m_nNextCountTime >= 0 then
		self:setNextBtnText(self.m_nNextCountTime .. "S", 1)
	else
		element:disableSchedule()
		element:setTouchEnable(true)
		self:setNextBtnText(LocalStrings.MASTERINFO25, 2)
	end
end
...
function WndMatchmaking:setRegisterBtn()
	...
	-- else
		if self.m_nRegisterState == 0 then
			txtRegister:setText(LocalStrings.MATCHMAKE_TEXT6)
			txtRegister:setStrokeColor(GlobalMethod:ccc3(0,108,3))
			img9Register1:setFile("ui/common/common_btn_02.png")
			img9Register2:setFile("ui/common/common_btn_02.png")
			img9Register3:setFile("ui/common/common_btn_02.png")
		else
			txtRegister:setText(LocalStrings.CHANGE)
			txtRegister:setStrokeColor(GlobalMethod:ccc3(163,74,20))
			img9Register1:setFile("ui/common/common_btn_01.png")
			img9Register2:setFile("ui/common/common_btn_01.png")
			img9Register3:setFile("ui/common/common_btn_01.png")
		end
...
function WndMatchmaking:_adaptLanguage_en(  )
	...
	GetElement(self.m_root, "txtRecommend_WndMatchmaking", WZUILabelTTF):setScale(0.7)
end
...
function WndMatchmaking:_adaptLanguage_tr(  )
	GetElement(self.m_root, "txtRecommend_WndMatchmaking", WZUILabelTTF):setScale(0.7)
	GetElement(self.m_root, "txtSexName_WndMatchmaking", WZUILabelTTF):setScale(0.7)
end
-------------------------------------语言适配End----------------------------------------
