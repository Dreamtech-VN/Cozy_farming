...
function CellMarryLetter:_update()
	...
	if self.m_nServerId ~= CacheCenter:getPlayerInfo().serverId then 
		GetElement(self.m_root, "imgKuafuIcon_CellMarryLetter", WZUIImage):setVisible(true)
		GetElement(self.m_root, "txtPlayerName_CellMarryLetter", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.235, 0.5))
		GetElement(self.m_root, "txtMarrayInfo_CellMarryLetter", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.425, 0.5))
	end
