...
function WndMarry:onClickProposeCell(element)
    ...
    GetElement(self.m_root,"txtCellSel".. self.m_nMarryType .."_WndMarry",WZUILabelTTF):setVisible(false)
    GetElement(self.m_root,"txtCell".. self.m_nMarryType .."_WndMarry",WZUILabelTTF):setVisible(true)
    GetElement(self.m_root,"txtCellSel".. tag .."_WndMarry",WZUILabelTTF):setVisible(true)
    GetElement(self.m_root,"txtCell".. tag .."_WndMarry",WZUILabelTTF):setVisible(false)
...
function WndMarry:onClickGiftCell(element)
    ...
    GetElement(self.m_root,"txtGiftSel".. self.m_nMarryType .."_WndMarry",WZUILabelTTF):setVisible(false)
    GetElement(self.m_root,"txtGift".. self.m_nMarryType .."_WndMarry",WZUILabelTTF):setVisible(true)
    GetElement(self.m_root,"txtGiftSel".. tag .."_WndMarry",WZUILabelTTF):setVisible(true)
    GetElement(self.m_root,"txtGift".. tag .."_WndMarry",WZUILabelTTF):setVisible(false)
    ...
    elseif self.m_nOperType == 2 then
        ...
        for i=1,4 do
            ...
            if icon == "shopitems/marry_05.png" then
                icon = "ui/marrige/common_icon_sjq.png"
            ...
            GetElement(self.m_root,"txtGiftSel" .. i .. "_WndMarry",WZUILabelTTF):setText(giftInfo.name)
        end
...
function WndMarry:_adaptLanguage_ug()
    local txtBtnPropose = GetElement(self.m_root,"txtBtnPropose_WndMarry",WZUILabelTTF)
    txtBtnPropose:setScale(0.55)
    txtBtnPropose:setDimensions(GlobalMethod:CCSize(220))

    local txtBtnSendGift = GetElement(self.m_root,"txtBtnSendGift_WndMarry",WZUILabelTTF)
    txtBtnSendGift:setScale(0.7)
    txtBtnSendGift:setDimensions(GlobalMethod:CCSize(180))

    GetElement(self.m_root,"txtProp1_WndMarry",WZUILabelTTF):setScale(0.8)
    GetElement(self.m_root,"txtProp2_WndMarry",WZUILabelTTF):setScale(0.8)
    GetElement(self.m_root,"txtProp3_WndMarry",WZUILabelTTF):setScale(0.8)
    GetElement(self.m_root,"txtProp4_WndMarry",WZUILabelTTF):setScale(0.8)
    
    GetElement(self.m_root,"txtGift1_WndMarry",WZUILabelTTF):setScale(0.7)
    GetElement(self.m_root,"txtGift2_WndMarry",WZUILabelTTF):setScale(0.7)
    GetElement(self.m_root,"txtGift3_WndMarry",WZUILabelTTF):setScale(0.7)
    GetElement(self.m_root,"txtGift4_WndMarry",WZUILabelTTF):setScale(0.7)
end
-------------------------------------语言适配模块End----------------------------------------
