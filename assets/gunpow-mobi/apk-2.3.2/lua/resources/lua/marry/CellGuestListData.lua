...
function CellGuestList:_init()
    ...
    self.m_nType = 1
	self.m_moveWidth = 1136
	self.m_moveHeigth = 130
end
...
function CellGuestList:_unInit()
    ...
    self.m_nServerId = nil 
    self.m_nType = nil
	self.m_moveWidth = nil
	self.m_moveHeigth = nil
end
...
--@brief	设置宾客名字
--@param	sName:宾客名字
function CellGuestList:setPlayerName(sName, serverId)
...
function CellGuestList:setType(nType)
	self.m_nType = nType
	...
	if nType == 1 then
		...
		self.m_moveHeigth = 130
	elseif nType == 2 then
		self.m_moveWidth = 400
		self.m_moveHeigth = 60
	end
