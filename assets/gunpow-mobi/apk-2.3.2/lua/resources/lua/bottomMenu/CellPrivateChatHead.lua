...
--	WZLog("CellPrivateChatHead:updateHead")
	...
	local cellElement,cellLuaObject = CellHead:show(conPlayerHead,self.m_tData.head,self.m_tData.face,self.m_tData.sex,nil,GlobalMethod:ccp(0.5,0.29),self.m_tData.vipLevel,self.m_tData.headColor, nil, nil, nil, nil, self.m_tData.headEffectId)
