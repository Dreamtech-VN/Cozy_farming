...
function CellMailList:onClickCurCell(element)
    ...
    GetElement(self.m_root,"imgCellBg_CellMailList",WZUI9Image):setFile("ui/common/frame_lieb_01.png")
end
...
function CellMailList:setChoiceState(state)
	...
	if state then
		element:setFile("ui/common/frame_lieb_01.png")
	else
		element:setFile("ui/common/frame_lieb.png")
	end
end
