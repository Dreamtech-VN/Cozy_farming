...
WndPromiseShrine._FONT_NORMAL_STYLE = '<T C="255,236,193" SC="132,66,29" SS="4" S="22" P="1" SE="1">%s</T>'
WndPromiseShrine._FONT_BLUE_STYLE = '<T C="93,222,254" SC="132,66,29" SS="4" S="22" P="1" SE="1">%s</T>'

WndPromiseShrine._FONT_SALE_PRICE_TITLE_STYLE = '<T C="255,236,193" SC="132,66,29" SS="4" S="20" P="1" SE="1">%s</T>'
WndPromiseShrine._FONT_SALE_PRICE_STYLE = '<T C="255,236,193" SC="132,66,29" SS="4" S="20" P="1" SE="1">%s</T><T C="255,236,193" SC="132,66,29" SS="4" S="28" P="1" SE="1">%s</T>'
...
function WndPromiseShrine:_getFormatActivityDate()
	if not self.m_tData or nil == self.m_tData then
		return ""
	end
	...
	if not tStartDate or not tEndDate then
		return ""
	end
...
local __findFunc = function(price, item_id, channelId)
	for k, _rechargeConfig in pairs(GDatatab_recharge) do
		...
		if price == _price and item_id == _item_id then
