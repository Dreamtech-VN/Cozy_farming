...
function CellMarryFriend:_showName()
    ...
    if self.m_nInterface == 5 then
        ...
        local sValueFormat = [[<T C="255,227,116" S="22" P="1">%s</T><T C="255,236,193" S="22" P="1">%d</T>]]
        ...
        txtName:setRelativePosition(GlobalMethod:ccp(0.157,0.5))
...
function CellMarryFriend:_adaptLanguage_ug(  )
    GetElement(self.m_root,"txtFriendsLiness_CellMarryFriend",WZUIFreeTextBox):setScale(0.8)
end
------------------------------------------语言适配End--------------------------------------
