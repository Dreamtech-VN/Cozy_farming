...
function CellFriendList:_showName()
    ...
    SetQQHallBlueIcon(self.m_root, self.m_tFriend.qqHallData, {"imgBluePri_CellFriendList", "imgBlueYear_CellFriendList"}, {"txtName_CellFriendList"}, {WZUILabelTTF}, 0.035)
end

--@brief	显示等级
function CellFriendList:_showLevel()
    WZLog("CellFriendList:_showLevel()")
    local levelStr = string.format("%d",self.m_tFriend.level)
    GetElement(self.m_root,"txtLevel2_CellFriendList",WZUILabelTTF):setText(levelStr)
end
--@brief    显示玩家头像
