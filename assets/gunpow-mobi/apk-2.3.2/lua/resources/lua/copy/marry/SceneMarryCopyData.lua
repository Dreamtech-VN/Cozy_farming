...
function SceneMarryCopy:_init()
	...
	self.m_tSweepCost = nil --扫荡消耗

    self.m_nLoveLevel = nil
...
function SceneMarryCopy:setMerryRoomData(roomId, passWord, roomName, playerNumMode, mapId, wnersId,
	...
	WZLog("SceneMarryCopy:setMerryRoomData",roomId,passWord,roomName,playerNumMode,mapId,wnersId,playerNum, Serialize(VectorToTable(serverId)))
...
--@brief    更新技能方案名字
function SceneMarryCopy:updateSkillSuitData()
    -- body
...
function SceneMarryCopy:receivePropInfo(manName, womanName, loveExp, loveLevel, giftNum, manHeadId, manFaceId, manBodyId, manWingId, womanHeadId, womanFaceId, womanBodyId, womanWingId,partnerId,manHeadColor,manBodyColor,womanHeadColor,womanBodyColor, manServerId, womanServerId, manSkillEndTime, womanSkillEndTime)
	WZLog("SceneMarryCopy:receivePropInfo")
...
function SceneMarryCopy:_canShowSkill(skillList)
...
--@brief 	获取挑战剩余次数
function SceneMarryCopy:getLeftFightTimes()
	-- body
