...
function SceneWorldTeamBoss:onClickRewardBox(element)
    ...
    WndTips:show(element, SceneWorldTeamBoss.m_root, 3, rewardList, GlobalMethod:ccp(20,100), true)
end
...
function SceneWorldTeamBoss:_buildGuai()
    ...
    guai:getShopAnimation():setScale(bossData.scale/100 + 0.2)
...
function SceneWorldTeamBoss:_adaptLanguage_tr(  )
    GetElement(self.m_root,"ftxtGoldCost_SceneWorldTeamBoss",WZUIFreeTextBox):setScale(0.8)
    GetElement(self.m_root,"ftxtDiaCost_SceneWorldTeamBoss",WZUIFreeTextBox):setScale(0.8)

    GetElement(self.m_root, "txtLeftTimes_SceneWorldTeamBoss", WZUILabelTTF):setScale(0.8)
end
