...
function WndDailyCopy:onEnterTransitionDidFinish(element)
    ...
    if ftxtCleanoutCost then
        local sFormat = [[<I Z="0.6">%s</I><T C="255,255,255" S="24" P="1" SC="164,74,21" SS="4" SE="1">x%d%s</T>]]
...
function WndDailyCopy:updateCopyInfo(tag)
    ...
    local ftxtChallenge = GetElement(self.m_root, "ftxtChallenge_WndDailyCopy", WZUIFreeTextBox)
    if ftxtChallenge then
        local sFormat = [[<I Z="0.7">ui/common/common_icon_huoli.png</I><T C="255,255,255" S="24" P="1" SC="0,108,7" SS="4" SE="1">x%d%s</T>]]
        ftxtChallenge:setShowText(string.format(sFormat, usePower, LocalStrings.CHALLENGEENTRANCE_TITLE))
    end
...
function WndDailyCopy:_adaptLanguage_tr(  )
    ...
    GetElement(self.m_root,"conPowerSub_WndDailyCopy",WZUIContainer):setRelativePosition(GlobalMethod:ccp(0.125,5.3))
end
...
function WndDailyCopy:_adaptLanguage_vn(  )
    ...
    ftxtCleanoutCost:setMaxWidth(300)
    local ftxtChallenge = GetElement(self.m_root, "ftxtChallenge_WndDailyCopy", WZUIFreeTextBox)
    ftxtChallenge:setScale(0.75)
    ftxtChallenge:setMaxWidth(300)
end

function WndDailyCopy:_adaptLanguage_ug(  )
    GetElement(self.m_root,"txtCopyDesc_WndDailyCopy",WZUILabelTTF):setDimensions(GlobalMethod:CCSize(450,0))

    GetElement(self.m_root,"txtFightNum_WndDailyCopy",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.94,0.5))
    GetElement(self.m_root,"txtFightNum2_WndDailyCopy",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(-0.865,0.5))

    GetElement(self.m_root,"txtPowerSub_WndDailyCopy",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(2.05,0.5))
    GetElement(self.m_root,"txtPowerSub2_WndDailyCopy",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.51282,0.5))
    GetElement(self.m_root,"conPowerSub3_WndDailyCopy",WZUIContainer):setRelativePosition(GlobalMethod:ccp(0.32192,0.5))
    
    local txtResert1 = GetElement(self.m_root,"txtResert1_WndDailyCopy",WZUILabelTTF)
    txtResert1:setScale(0.8)
    txtResert1:setDimensions(GlobalMethod:CCSize(160))
    local txtResert2 = GetElement(self.m_root,"txtResert2_WndDailyCopy",WZUILabelTTF)
    txtResert2:setScale(0.8)
    txtResert2:setDimensions(GlobalMethod:CCSize(160))
