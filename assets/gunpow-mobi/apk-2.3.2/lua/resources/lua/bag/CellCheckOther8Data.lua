...
function CellCheckOther8:createElement()
	...
	tNewObj:_init()
	local element = WZUISystem:getInstance():createElement("CellCheckOther8")
	assert(element, "CellCheckOther8 element create failed!")
...
--@brief 	设置标题
function CellCheckOther8:setTitle(text, nRowNum, nType)
	-- body
	self.m_sTitle = text
