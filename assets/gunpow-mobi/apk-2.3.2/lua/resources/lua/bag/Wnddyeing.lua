...
function Wnddyeing:ranseAni()
	...
	local spinePath = "ui/otherUI/ui_ranse"
...
function Wnddyeing:_adaptLanguage_ug()
	local colorH = GetElement(self.m_root,"colorHead",WZUILabelTTF)
	colorH:setScale(0.7)
	colorH:setDimensions(GlobalMethod:CCSize(200,0))
	local colorB = GetElement(self.m_root,"colorBody",WZUILabelTTF)
	colorB:setScale(0.7)
	colorB:setDimensions(GlobalMethod:CCSize(200,0))

	local txtNotice = GetElement(self.m_root,"txtNotice_Wnddyeing",WZUILabelTTF)
	txtNotice:setScale(0.65)
	txtNotice:setDimensions(GlobalMethod:CCSize(640))
	txtNotice:setRelativePosition(GlobalMethod:ccp(-0.03,0.885))
	txtNotice:setAlignment(kCCTextAlignmentRight)
	GetElement(self.m_root,"txtCost_Wnddyeing",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.487179,0.635))
	GetElement(self.m_root,"imgCost",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.441539,0.635))
	GetElement(self.m_root,"cost",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.327437,0.635))
	local has = GetElement(self.m_root,"has",WZUILabelTTF)
	has:setRelativePosition(GlobalMethod:ccp(0.314873,0.635))
	has:setAnchorPoint(GlobalMethod:ccp(1,0.5))

	for i=1,3 do
		local txtSure = GetElement(self.m_root,"txtSure"..i.."_Wnddyeing",WZUILabelTTF)
		txtSure:setScale(0.7)
		txtSure:setDimensions(GlobalMethod:CCSize(170,0))
	end
