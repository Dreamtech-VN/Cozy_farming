...
function WndSynthesisRight:_setTextColorByTag(tag)
	...
	for i=1,5 do
		self:_setTextColor(self.m_root:getChildElement("txtTab"..i.."_WndSynthesisRight"),GlobalMethod:ccc3(127,70,26))
    	GetElement(self.m_root, "imgTab"..i.."_WndSynthesisRight", WZUI9Image):setVisible(false)
	end
	self:_setTextColor(self.m_root:getChildElement("txtTab"..tag.."_WndSynthesisRight"),GlobalMethod:ccc3(255,236,193),GlobalMethod:ccc3(127,70,26))
...
function WndSynthesisRight:_adaptLanguage_ug(  )
    local txtTab2 = GetElement(self.m_root,"txtTab2_WndSynthesisRight",WZUILabelTTF)
    txtTab2:setScale(0.7)
    txtTab2:setDimensions(GlobalMethod:CCSize(110))
    GetElement(self.m_root,"txtTab4_WndSynthesisRight",WZUILabelTTF):setScale(0.6)

    GetElement(self.m_root,"txtSale_WndEquipNew",WZUILabelTTF):setScale(0.7)
    local txtSys_WndEquipNew = GetElement(self.m_root,"txtSys_WndEquipNew",WZUILabelTTF)
    txtSys_WndEquipNew:setScale(0.7)
    txtSys_WndEquipNew:setDimensions(GlobalMethod:CCSize(180))
end
