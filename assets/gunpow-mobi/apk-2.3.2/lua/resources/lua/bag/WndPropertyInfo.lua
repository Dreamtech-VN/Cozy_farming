...
function WndPropertyInfo:update() 
	...
	local tData = {
        attrInfo1=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.HEALTH,LocalStrings.ATTRTIP1),
        attrInfo2=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.ATTACK,LocalStrings.ATTRTIP2),
        attrInfo3=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.DEFENSE,LocalStrings.ATTRTIP3),
        attrInfo4=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.CRIT,LocalStrings.ATTRTIP4),
        attrInfo5=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.FREESTORM,LocalStrings.ATTRTIP5),
        attrInfo6=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.TIZHI,LocalStrings.ATTRTIP6),
        attrInfo7=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.POWER,LocalStrings.ATTRTIP7),
        attrInfo8=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.PRACTICE_ARMOR,LocalStrings.ATTRTIP8),
        attrInfo9=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.AGILITY,LocalStrings.ATTRTIP9),
        attrInfo10=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.LUCKY,LocalStrings.ATTRTIP10),
        attrInfo11=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.ANTIBREAKING,LocalStrings.ATTRTIP11),
        attrInfo12=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.AVOIDINJURY,LocalStrings.ATTRTIP12),
        attrInfo13=string.format([[<T C="127,70,26" S="18" P="0">%s:%s</T>]],LocalStrings.RANGE,LocalStrings.ATTRTIP13),
    }
	for i=1,13 do
...
function WndPropertyInfo:_adaptLanguage_ug(  )
    GetElement(self.m_root,"txtUser_WndPlayerInfo",WZUILabelTTF):setScale(0.6)

    for i=1,13 do
        for i=1,13 do
            local attrInfo = GetElement(self.m_root,"attrInfo"..i,WZUIFreeTextBox)
            attrInfo:setScale(0.55)
            attrInfo:setMaxWidth(700)
        end
    end

    local attrTitle1 = GetElement(self.m_root,"attrTitle1_WndPlayerInfo",WZUILabelTTF)
    attrTitle1:setScale(0.6)
    attrTitle1:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle1:setAlignment(kCCTextAlignmentRight)
    attrTitle1:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle2 = GetElement(self.m_root,"attrTitle2_WndPlayerInfo",WZUILabelTTF)
    attrTitle2:setScale(0.6)
    attrTitle2:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle2:setAlignment(kCCTextAlignmentRight)
    attrTitle2:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle3 = GetElement(self.m_root,"attrTitle3_WndPlayerInfo",WZUILabelTTF)
    attrTitle3:setScale(0.6)
    attrTitle3:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle3:setAlignment(kCCTextAlignmentRight)
    attrTitle3:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle4 = GetElement(self.m_root,"attrTitle4_WndPlayerInfo",WZUILabelTTF)
    attrTitle4:setScale(0.6)
    attrTitle4:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle4:setAlignment(kCCTextAlignmentRight)
    attrTitle4:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle5 = GetElement(self.m_root,"attrTitle5_WndPlayerInfo",WZUILabelTTF)
    attrTitle5:setScale(0.6)
    attrTitle5:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle5:setAlignment(kCCTextAlignmentRight)
    attrTitle5:setRelativePosition(GlobalMethod:ccp(1,0.5))
    attrTitle5:setDimensions(GlobalMethod:CCSize(200))
    local attrTitle7 = GetElement(self.m_root,"attrTitle7_WndPlayerInfo",WZUILabelTTF)
    attrTitle7:setScale(0.6)
    attrTitle7:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle7:setAlignment(kCCTextAlignmentRight)
    attrTitle7:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle8 = GetElement(self.m_root,"attrTitle8_WndPlayerInfo",WZUILabelTTF)
    attrTitle8:setScale(0.6)
    attrTitle8:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle8:setAlignment(kCCTextAlignmentRight)
    attrTitle8:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle9 = GetElement(self.m_root,"attrTitle9_WndPlayerInfo",WZUILabelTTF)
    attrTitle9:setScale(0.6)
    attrTitle9:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle9:setAlignment(kCCTextAlignmentRight)
    attrTitle9:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle10 = GetElement(self.m_root,"attrTitle10_WndPlayerInfo",WZUILabelTTF)
    attrTitle10:setScale(0.6)
    attrTitle10:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle10:setAlignment(kCCTextAlignmentRight)
    attrTitle10:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle11 = GetElement(self.m_root,"attrTitle11_WndPlayerInfo",WZUILabelTTF)
    attrTitle11:setScale(0.6)
    attrTitle11:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle11:setAlignment(kCCTextAlignmentRight)
    attrTitle11:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local attrTitle12 = GetElement(self.m_root,"attrTitle12_WndPlayerInfo",WZUILabelTTF)
    attrTitle12:setScale(0.6)
    attrTitle12:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle12:setAlignment(kCCTextAlignmentRight)
    attrTitle12:setRelativePosition(GlobalMethod:ccp(0.9,0.5))
    attrTitle12:setDimensions(GlobalMethod:CCSize(140))
    local attrTitle6 = GetElement(self.m_root,"attrTitle6_WndPlayerInfo",WZUILabelTTF)
    attrTitle6:setScale(0.6)
    attrTitle6:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle6:setAlignment(kCCTextAlignmentRight)
    attrTitle6:setRelativePosition(GlobalMethod:ccp(0.9,0.5))
    ...
    attrTitle13:setScale(0.6)
    attrTitle13:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attrTitle13:setAlignment(kCCTextAlignmentRight)
    attrTitle13:setRelativePosition(GlobalMethod:ccp(0.9,0.5))

    local attr1 = GetElement(self.m_root,"attr1_WndPlayerInfo",WZUILabelTTF)
    attr1:setScale(0.6)
    attr1:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr1:setAlignment(kCCTextAlignmentRight)
    attr1:setRelativePosition(GlobalMethod:ccp(0.62,0.5))
    local attr2 = GetElement(self.m_root,"attr2_WndPlayerInfo",WZUILabelTTF)
    attr2:setScale(0.6)
    attr2:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr2:setAlignment(kCCTextAlignmentRight)
    attr2:setRelativePosition(GlobalMethod:ccp(0.72,0.5))
    local attr3 = GetElement(self.m_root,"attr3_WndPlayerInfo",WZUILabelTTF)
    attr3:setScale(0.6)
    attr3:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr3:setAlignment(kCCTextAlignmentRight)
    attr3:setRelativePosition(GlobalMethod:ccp(0.62,0.5))
    local attr4 = GetElement(self.m_root,"attr4_WndPlayerInfo",WZUILabelTTF)
    attr4:setScale(0.6)
    attr4:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr4:setAlignment(kCCTextAlignmentRight)
    attr4:setRelativePosition(GlobalMethod:ccp(0.333333,0.5))
    local attr5 = GetElement(self.m_root,"attr5_WndPlayerInfo",WZUILabelTTF)
    attr5:setScale(0.6)
    attr5:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr5:setAlignment(kCCTextAlignmentRight)
    attr5:setRelativePosition(GlobalMethod:ccp(0.226666,0.5))
    local attr7 = GetElement(self.m_root,"attr7_WndPlayerInfo",WZUILabelTTF)
    attr7:setScale(0.6)
    attr7:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr7:setAlignment(kCCTextAlignmentRight)
    attr7:setRelativePosition(GlobalMethod:ccp(0.46,0.5))
    local attr8 = GetElement(self.m_root,"attr8_WndPlayerInfo",WZUILabelTTF)
    attr8:setScale(0.6)
    attr8:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr8:setAlignment(kCCTextAlignmentRight)
    attr8:setRelativePosition(GlobalMethod:ccp(0.84,0.5))
    local attr9 = GetElement(self.m_root,"attr9_WndPlayerInfo",WZUILabelTTF)
    attr9:setScale(0.6)
    attr9:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr9:setAlignment(kCCTextAlignmentRight)
    attr9:setRelativePosition(GlobalMethod:ccp(0.746666,0.5))
    local attr10 = GetElement(self.m_root,"attr10_WndPlayerInfo",WZUILabelTTF)
    attr10:setScale(0.6)
    attr10:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr10:setAlignment(kCCTextAlignmentRight)
    attr10:setRelativePosition(GlobalMethod:ccp(0.7,0.5))
    local attr11 = GetElement(self.m_root,"attr11_WndPlayerInfo",WZUILabelTTF)
    attr11:setScale(0.6)
    attr11:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr11:setAlignment(kCCTextAlignmentRight)
    attr11:setRelativePosition(GlobalMethod:ccp(0.746666,0.5))
    local attr12 = GetElement(self.m_root,"attr12_WndPlayerInfo",WZUILabelTTF)
    attr12:setScale(0.6)
    attr12:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr12:setAlignment(kCCTextAlignmentRight)
    attr12:setRelativePosition(GlobalMethod:ccp(0.406295,0.5))
    local attr6 = GetElement(self.m_root,"attr6_WndPlayerInfo",WZUILabelTTF)
    attr6:setScale(0.6)
    attr6:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr6:setAlignment(kCCTextAlignmentRight)
    attr6:setRelativePosition(GlobalMethod:ccp(0.506667,0.5))
    local attr13 = GetElement(self.m_root,"attr13_WndPlayerInfo",WZUILabelTTF)
    attr13:setScale(0.6)
    attr13:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    attr13:setAlignment(kCCTextAlignmentRight)
    attr13:setRelativePosition(GlobalMethod:ccp(0.6,0.5))
end
-------------------------------------语言适配End--------------------------------------------