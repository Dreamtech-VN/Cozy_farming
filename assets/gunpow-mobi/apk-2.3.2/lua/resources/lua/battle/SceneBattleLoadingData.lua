...
function SceneBattleLoading:_init()
    ...
    self.m_tPlayerProfessionSkill = nil --玩家的职业技能
    MsgManager:clear()
    self.m_nCheckGuaiResIndex = 0 		--是否检测过怪物资源是否存在
    self.m_nCheckPlayerResIndex = 0 		--是否检测过人物资源是否存在
end
...
function SceneBattleLoading:_unInit()
    ...
    self.m_tPlayerProfessionSkill = nil 
    self.m_nCheckGuaiResIndex = nil 		--是否检测过怪物资源是否存在
    self.m_nCheckPlayerResIndex = nil 		--是否检测过人物资源是否存在
end
