...
TakeEffectType = 
{
    ...
    HIT = 1,    --击中生效
    TREASURE = 2, --宝箱
    COLLISION = 3, --碰撞生效(效果立即失效)
    KILL = 4,   --击杀生效
    END_CUR_ROUND = 5,   --回合结束时生效
    USEITEMS = 6,   --使用道具时生效
    ENEMY_DEAD = 7,   --敌人死亡时生效
    BEHIT_TODEAD = 8,   --受到致命伤害生效
    SUPERCRIT = 9,   --超爆击时生效
    INJURED = 10,   --受伤时生效
    BEFORE_DOEFFECT = 11,   --造成伤害前时生效

    HIT_ENEMY = 13,   --击中敌方

    COLLISION_TWO = 14, --碰撞生效(效果回合结束失效)
    BETWEEN_ATTACK_HURT = 15, --击中敌人和产生伤害之间生效
    AFTERHURT_DOEFFECT = 16,   --造成伤害后生效
    AFTER_BLEED = 17, --流血之后生效

    BULLET_HIT = 18, --每颗子弹击中都会生效一遍,区别于生效类型1在一回合中多次被击中只生效一次 (如:处女座皮肤大招多段击中加血有用到)

    HIT_TWO = 19, --同1一样,主要服务端用来区分1,傀儡师大招技能连锁用到这个生效类型
}
...
EffectTypeConfig =
{
    ...
    CHANGE_ATTRIBUTE_PERCENT_HURT2 = "1_6",     --根据攻击力改变属性百分比 主要用来处理玩家吸血,打敌人才加血
    CHANGE_ATTRIBUTE_PERCENT_HURT3 = "1_7",     --根据攻击力改变属性百分比 主要用来处理玩家吸血,打任何人都加血
    HURT = "2_1",                       --伤害计算
    RECOVERY = "2_2",                   --回血计算
    CHANGE_RECOVERY_PERCENT = "2_3",    --改变受到治疗效果万分比
    EXTRA_HP = "2_4",                   --加万分比的额外生命 
    ...
    CHANGE_WIND_ADD_HURT_PERCENT = "3_12", --按风力附加伤害万分比
    CHANGE_HURT_TO_ENEMY = "3_13",         --只对敌认造成伤害百分比
    CHANGE_HURT_TO_TEAMMATE = "3_14",      --只对对友造成伤害百分比
    ...
    LIMIT_STOP_CTB_BUFF = "5_13",            --停止CTB和BUFF(除了放逐buff自身)
    ...
    ADD_BUFF = "8_1",                   --添加BUFF
    ADD_RANDOMBUFF = "8_2",             --添加随机BUFF
    ADD_RANDOM_BUFF_TWO = "8_3",        --添加随机BUFF(般若大招用到)
    ...
    REDUCE_BUFFCTB_ALL = "9_5",         --扣减所有BUFFCTB

    TRACK_SHOOT = "10_1",               --追踪弹
    SCATTER_SHOOT = "11_1",             --散射弹
    RANDOM_SCATTER_SHOOT = "11_2",      --屏幕上方随机位置散射弹
    TIMES_SHOOT = "12_1",               --连击弹
    NO_HOLE = "13_1",                   --免坑

    CHAIN_OTHER = "14_1",               --与其他人连锁
    CHAIN_OTHER_TWO = "14_2",           --拥有buff的目标都连锁
    INVINCIBLE = "15_1",                --无敌
    IMMUNITY_ATTACK = "15_2",           --不会受到攻击
    HIDE = "16_1",                      --隐身
    ...
    -- TORNADO = "25_1",                --龙卷
    SPATTER = "26_1",                   --溅射
    TWOSHOOT = "26_2",                  --先普通射击，碰撞后触发出手两次
    SPATTER_TWO = "26_3",               --哪吒大招第一阶段攻击后,溅射被第一阶段击中的敌人
    ...
    FIRE_TOTEM = "27_7",               --召唤火焰
    GUARDIAN_TOTEM = "27_8",           --召唤守护光环
    BLACK_HOLE = "27_9",           --召唤守护光环
    MARITIME1_TOTEM = "27_10",          --召唤海洋领域增益
    MARITIME2_TOTEM = "27_11",          --召唤海洋领域减益
    MARITIME3_TOTEM = "27_12",          --召唤海洋领域减益
    JIANGZIYA_TOTEM = "27_13",          --召唤姜子牙领域
    XUANZANG_TOTEM = "27_14",           --玄奘佛光
    UMBRELLA1_TOTEM = "27_15",            --执伞圣女 回血
    UMBRELLA2_TOTEM = "27_16",            --执伞圣女 反击
    SUMMON_SOULHERO = "27_17",            --召唤灵魂分身
    SUMMON_SUBCHESSHERO = "27_18",        --召唤棋子分身
    ...
    LOCK_ITSELF = "105_1",       --锁定本体攻击
    HURT_TRANS = "106_1",        --伤害传递给本体
    THORNS = "107_1",            --反伤防御的百分比
    THORNS_CONSTANT = "107_2",   --反伤固定值伤害
    THORNS_HURT_PERCENT = "107_3",   --反伤伤害值的百分比

    THORNS_PERCENT_RANDOM = "118_1",   --反伤伤害值的百分比 给随机一个敌人
    PROFESSION_SAVELIFE = "108_1",       --保命1点生命
    PROFESSION_SAVELIFE_PERCENT = "108_2",      --保命配置的百分比生命值
    PROFESSION_SAVELIFE_PERCENT_TWO = "108_3",     --保命配置的百分比生命值,区分108_2,需要做优先级
    PROFESSION_RANDOM_ITEMPROP = "109_1",       --获得随机使用过的道具

    PROFESSION_PET_BEATBACK = "110_1",  --宠物反击
    PET_CONTINUE_SHOOT = "111_1",       --宠物连击

    IGNORE_BUFF = "112_1",          --无视buff(对于一些限制行动的，可以配置无视)

    ABSORB_ATTRIBUTE_BECOMES_HURT = "113_1",          --吸取属性变成临时伤害
    SP_ADD_PERCENT = "115_1",       --玩家怒气增加百分比

    MARITIME_TOTEM_MOVE = "116_1",       --鲛人大招海洋领域增益,可以自由移动

    DISPERSE_MONSTER_BY_TYPE = "117_1", --驱散指定类型的怪物
...
MonsterConfig =
{
    ...
    {
        aniFileId = "boss_1012",
        animSize = {width=354,height=710},
        animNormal=[[shoot_1 = "shoot_1a"|shoot_2 = "shoot_2a"|shoot_3 = "shoot_3a"|standby = "wait_1"|skill1 = "atk_1a"|skill2 = "atk_2a"|hurt = "wound_1"|move = "run_1"|dead = "die"|fly = "fly"|summon = "summon"|atk_1a = "atk_1a"|atk_2a = "atk_2a"|atk_3a = "atk_3a"|disappear = "disappear"]],
        animViolent=nil,
        animAir=nil,
        animAirViolent=nil,
        armatureName = nil,
        armatureOffsetY = nil,
        armatureOffsetYAir = nil,
        rectCollision = {[1]={width=260,height=650,x=0,y=0},},
        rectCollisionAir = nil,
        animIsLeftFlip = nil,
        buffAnimOffsetX = -40,
        buffAnimOffsetY = 0,
        bulletPosOffset = {x=-140,y=410},
        isSpine = true,
    },
    ...
    monster_0042 =
    {
        ...
        armatureOffsetY = nil,
        armatureOffsetYAir = nil,
        rectCollision = {[1]={width=80,height=120,x=0,y=0},},
        rectCollisionAir = nil,
        animIsLeftFlip = nil,
        buffAnimOffsetX = -20,
        buffAnimOffsetY = 0,
        bulletPosOffset = {x=-40,y=140},
        isSpine = true,
    },
    monster_0043 =
    {
        ...
        armatureOffsetY = nil,
        armatureOffsetYAir = nil,
        rectCollision = {[1]={width=80,height=110,x=0,y=0},},
        rectCollisionAir = nil,
        animIsLeftFlip = nil,
        buffAnimOffsetX = -20,
        buffAnimOffsetY = 0,
        bulletPosOffset = {x=-80,y=70},
        isSpine = true,
    },
}
...
BattleMachineConfig =
{
    ...
    machine_1011 =
    {
        aniFileId = "skills_dz_xq_02",
        scale = 0.6,
        isMapCollision = true,
        animNormal=[[standby = "0"|skill = "0"|hurt = "0"|dead = "0"]],
        animSize = {width=150,height=80},
        rectCollision = {[1]={width=150,height=80,x=0,y=0},},
        animIsLeftFlip = false,
        isSpine = false,
        bulletPosOffset = nil,
    },
    ...
    machine_1012=
    {
        aniFileId = "skill_jineng_fire",
        scale = nil,
        -- isMapCollision = true,
        animNormal=[[standby = "skill_jineng_fire"|skill = "skill_jineng_fire"|hurt = "skill_jineng_fire"|dead = "skill_jineng_fire"]],
        animSize = {width=310,height=310},
        rectCollision = {[1]={width=310,height=310,x=80,y=40},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_1013=
    {
        aniFileId = "boss_0107_attack02",
        scale = 1.4,
        -- isMapCollision = true,
        animNormal=[[standby = "attack_1"|skill = "attack_1"|hurt = "attack_1"|dead = "attack_1"]],
        animSize = {width=410,height=410},
        rectCollision = {[1]={width=410,height=410,x=105,y=0},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_1014=
    {
        aniFileId = "skill_jineng_yinlidan",
        scale = nil,
        -- isMapCollision = true,
        animNormal=[[standby = "skill_jineng_yinlidan"|skill = "skill_jineng_yinlidan"|hurt = "skill_jineng_yinlidan"|dead = "skill_jineng_yinlidan"]],
        animSize = {width=310,height=310},
        rectCollision = {[1]={width=310,height=310,x=80,y=40},},
        animIsLeftFlip = false,
        isSpine = true,
    ...
    machine_1020=
    {
        aniFileId = "boss_0132_attack02",
        scale = nil,
        -- isMapCollision = true,
        animNormal=[[standby = "attcak_3"|skill = "attcak_3"|hurt = "attcak_3"|dead = "attcak_3"]],
        animSize = {width=900,height=900},
        rectCollision = {[1]={width=650,height=650,x=165,y=0},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_1015=
    {
        aniFileId = "boss_0144_attack3",
        scale = 1,
        -- isMapCollision = true,
        animNormal=[[standby = "wait"|skill = "wait"|hurt = "wait"|dead = "wait"]],
        animSize = {width=900,height=900},
        rectCollision = {[1]={width=900,height=900,x=225,y=30},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_1016=
    {
        aniFileId = "boss_0144_enemy_attack3",
        scale = 1,
        -- isMapCollision = true,
        animNormal=[[standby = "wait"|skill = "wait"|hurt = "wait"|dead = "wait"]],
        animSize = {width=900,height=900},
    ...
    machine_1018=
    {
        aniFileId = "boss_0141_attack02",
        scale = nil,
        -- isMapCollision = true,
        animNormal=[[standby = "shoot_1"|skill = "shoot_1"|hurt = "shoot_1"|dead = "shoot_1"]],
        animSize = {width=310,height=310},
        rectCollision = {[1]={width=310,height=310,x=80,y=0},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_1019=
    {
        aniFileId = "boss_0136_attack03",
        scale = nil,
        -- isMapCollision = true,
        animNormal=[[standby = "wait"|skill = "wait"|hurt = "wait"|dead = "wait"]],
        animSize = {width=900,height=900},
        rectCollision = {[1]={width=650,height=650,x=0,y=0},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
    ...
    machine_7001=
    {
        ...
        animNormal=[[standby = "wait"|skill = "wait"|hurt = "wait"|dead = "die"]],
        animSize = {width=60,height=80},
        rectCollision = {[1]={width=320,height=220,x=0,y=0},},
        animIsLeftFlip = false,
        isSpine = true,
        bulletPosOffset = nil,
    },
...
AttributeConfig =
{
    ...
    BlowUpRange = 25,
    FateCritRate = 134, --命运暴击概率（轮回审批共生技添加的新属性）
    FateCrit = 135,     --命运暴击倍数（轮回审批共生技添加的新属性）
    Fate_Hurt_FZ = 136, --命运伤害反转万分比（轮回审批共生技添加的新属性）
}
...
--宠物随机属性 对应tab_pet_random表的type字段
PetEquipRandomAttr = {
    PET_ATK_ADD_SP = 102,               --宠物攻击,自己获得怒气
    PET_ATK_SUB_SP = 103,               --宠物攻击,敌人减少怒气
    IMMUNEBUFF_POISON_RATE = 104,       --免疫中毒
    IMMUNEBUFF_BLEED_RATE = 105,        --免疫流血
    PETATTACK_FATAL_RATE = 110,        --致命一击
    PETATTACK_SUCKBLOOD_RATE = 111,    --吸血攻击
    PETATTACK_BLOWUP_RATE = 112,       --大力击飞
    PETATTACK_BLIND_RATE = 113,        --致盲一击
    PETATTACK_EASYHURT_RATE = 114,     --易伤一击
    IMMUNEBUFF_FROZEN_RATE = 115,      --免疫冰冻
    IMMUNEBUFF_SILENT_RATE = 116,      --免疫沉默
    IMMUNEBUFF_REDUCEHURT_RATE = 117,  --减免伤害
    PETATTACK_SUMMONFIRE_RATE = 119,   --召唤火焰圈
    PETATTACK_SUMMONBLACKHOLE_RATE = 120,   --召唤黑洞
    PETATTACK_SUMMONTORNADO_RATE = 121,   --召唤龙卷风
    PETATTACK_CHAIN_RATE = 122,        --连锁一击
    PETATTACK_CALM_RATE = 123,         --镇定一击
    PETATTACK_NOPIT_RATE = 124,        --免坑祝福
    PETATTACK_HIDE_RATE = 125,         --隐身祝福
    PETATTACK_THORNS_RATE = 126,       --反伤祝福

}

--宠物随机属性 效果Id
PetEquipRandomEffect = {
    INITIACTIVE_EFFECT_NUM = 13,    --宠物装备主动效果数量，如果后面再加效果，需要实时维护
    EFFECT_FATAL_ID = 1401,        --致命一击
    EFFECT_SUCKBLOOD_ID = 1402,    --吸血攻击
    EFFECT_BLOWUP_ID = 1403,       --大力击飞
    EFFECT_BLIND_ID = 1405,        --致盲一击
    EFFECT_EASYHURT_ID = 1406,     --易伤一击
    EFFECT_CALLFIRE_ID = 1407,     --召唤火焰圈
    EFFECT_CALLBLACKHOLE_ID = 1408,     --召唤黑洞
    EFFECT_CALLTORNADO_ID = 1409,     --召唤龙卷风
    EFFECT_CHAIN_ID = 1410,     --连锁一击
    EFFECT_CALM_ID = 1411,     --镇定一击
    EFFECT_NOPIT_ID = 1412,     --免坑祝福
    EFFECT_HIDE_ID = 1413,     --隐身祝福
    EFFECT_THORNS_ID = 1414,     --反伤祝福
    EFFECT_REDUCEHURT_ID = 1404,   --减免伤害   这个是被动效果
}