...
function WndCopyFlyInfoView:_adaptLanguage_ug( )
    GetElement(self.m_root, "txtDescribeO_WndCopyFlyInfoView", WZUILabelTTF):setScale(0.68)

    local txtDescribeF = GetElement(self.m_root, "txtDescribeF_WndCopyFlyInfoView", WZUILabelTTF)
    txtDescribeF:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtDescribeF:setScale(0.68)
    txtDescribeF:setRelativePosition(GlobalMethod:ccp(1,0.5))
    local txtResultF = GetElement(self.m_root, "txtResultF_WndCopyFlyInfoView", WZUILabelTTF)
    txtResultF:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtResultF:setScale(0.68)
    txtResultF:setRelativePosition(GlobalMethod:ccp(0.35,0.5))

    local txtDescribeT = GetElement(self.m_root, "txtDescribeT_WndCopyFlyInfoView", WZUILabelTTF)
    txtDescribeT:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtDescribeT:setScale(0.68)
    txtDescribeT:setRelativePosition(GlobalMethod:ccp(1,0.5))
    txtDescribeT:setDimensions(GlobalMethod:CCSize(200))
    local txtResultT = GetElement(self.m_root, "txtResultT_WndCopyFlyInfoView", WZUILabelTTF)
    txtResultT:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtResultT:setScale(0.68)
    txtResultT:setRelativePosition(GlobalMethod:ccp(0.35,0.5))
