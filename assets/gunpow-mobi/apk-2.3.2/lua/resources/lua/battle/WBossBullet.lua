...
WBossBullet = {
    ...
    m_bIsBossBullet = true      		--用来区分WBossBullet和WBullet
}
...
--@brief 插入已计算影响队列
function WBossBullet:addInfluenceList(battleId)
    WBullet.addInfluenceList(self, battleId)
end

--@brief    检测是否已经添加过，防止重复影响计算引力
function WBossBullet:checkCanInfluence(battleId)
    return WBullet.checkCanInfluence(self, battleId)
end
-------------------------------------私有方法模块--------------------------------------
