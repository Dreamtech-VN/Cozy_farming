...
function BattlePlayerBigSkillAnim:_adjustStep1()
	...
	if self.m_psq then
		...
		if self.m_tAnims[1] then
			self.m_tAnims[1]:getAnimNode():setRelativePosition(GlobalMethod:ccp( (point.x - 30) /1136 , (point.y-40) /640 ))
		end

		self.m_psq:setRelativePosition(GlobalMethod:ccp( (point.x - 0) /1136 , (point.y-0) /640 ))
	end
end
...
function BattlePlayerBigSkillAnim:_step1()
	...
	--anim:getAnimNode():setRelativePosition(GlobalMethod:ccp( (point.x - 30) /1136 , (point.y-40) /640 ))
