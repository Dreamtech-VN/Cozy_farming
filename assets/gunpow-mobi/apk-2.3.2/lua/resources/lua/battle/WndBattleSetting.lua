...
function WndBattleSetting:_updateLanguageText()
    ...
    if WBattleGlobal:getCurrent().m_tMakePairOk.battleChannle == GlobalGame.g_tRoomChannel.BATTLE_CHANNEL_ZLS then
        isRank = true
        warnging = warnging and true
    end
...
function WndBattleSetting:_adaptLanguage_ug()
    local txtExitGame1 = GetElement(self.m_root,"txtExitGame1_WndBattleSetting",WZUILabelTTF)
    txtExitGame1:setDimensions(GlobalMethod:CCSize(140))
    txtExitGame1:setScale(0.7)
    local txtExitGame2 = GetElement(self.m_root,"txtExitGame2_WndBattleSetting",WZUILabelTTF)
    txtExitGame2:setDimensions(GlobalMethod:CCSize(140))
    txtExitGame2:setScale(0.7)
    local txtExitGame3 = GetElement(self.m_root,"txtExitGame3_WndBattleSetting",WZUILabelTTF)
    txtExitGame3:setDimensions(GlobalMethod:CCSize(140))
    txtExitGame3:setScale(0.7)

    local txtLabel1 = GetElement(self.m_root,"txtLabel1_WndBattleSetting",WZUILabelTTF)
    txtLabel1:setDimensions(GlobalMethod:CCSize(140))
    txtLabel1:setScale(0.7)
    local txtLabel2 = GetElement(self.m_root,"txtLabel2_WndBattleSetting",WZUILabelTTF)
    txtLabel2:setDimensions(GlobalMethod:CCSize(140))
    txtLabel2:setScale(0.7)
    local txtLabel3 = GetElement(self.m_root,"txtLabel3_WndBattleSetting",WZUILabelTTF)
    txtLabel3:setDimensions(GlobalMethod:CCSize(140))
    txtLabel3:setScale(0.7)
    
    local txtLabel1 = GetElement(self.m_root,"txtLabel1_WndBattleSetting",WZUILabelTTF)
    txtLabel1:setScale(0.6)
    local txtLabel2 = GetElement(self.m_root,"txtLabel2_WndBattleSetting",WZUILabelTTF)
    txtLabel2:setScale(0.6)
    local txtLabel3 = GetElement(self.m_root,"txtLabel3_WndBattleSetting",WZUILabelTTF)
    txtLabel3:setScale(0.6)

    local txtLabel1 = GetElement(self.m_root,"txtMusic_WndBattleSetting",WZUILabelTTF)
    txtLabel1:setDimensions(GlobalMethod:CCSize(180))
    txtLabel1:setScale(0.7)
    txtLabel1:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtLabel1:setRelativePosition(GlobalMethod:ccp(0.97,0.5))
    local txtLabel2 = GetElement(self.m_root,"txtSound_WndBattleSetting",WZUILabelTTF)
    txtLabel2:setDimensions(GlobalMethod:CCSize(180))
    txtLabel2:setScale(0.7)
    txtLabel2:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtLabel2:setRelativePosition(GlobalMethod:ccp(0.97,0.5))
    local txtLabel3 = GetElement(self.m_root,"txtLine_WndBattleSetting",WZUILabelTTF)
    txtLabel3:setDimensions(GlobalMethod:CCSize(180))
    txtLabel3:setScale(0.7)
    txtLabel3:setAnchorPoint(GlobalMethod:ccp(1,0.5))
    txtLabel3:setRelativePosition(GlobalMethod:ccp(0.97,0.5))

    local conMusicOption = GetElement(self.m_root,"conMusicOption_WndBattleSetting",WZUIContainer)
    conMusicOption:setRelativePosition(GlobalMethod:ccp(0.3,0.5))
    local conSoundOption = GetElement(self.m_root,"conSoundOption_WndBattleSetting",WZUIContainer)
    conSoundOption:setRelativePosition(GlobalMethod:ccp(0.3,0.5))
    local conLineOption = GetElement(self.m_root,"conLineOption_WndBattleSetting",WZUIContainer)
    conLineOption:setRelativePosition(GlobalMethod:ccp(0.3,0.5))
end
-------------------------------------语言适配End--------------------------------------------