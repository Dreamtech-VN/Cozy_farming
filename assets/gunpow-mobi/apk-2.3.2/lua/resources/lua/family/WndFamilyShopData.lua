...
function WndFamilyShop:setData(configId, freeTimes, currentNum, numLimit)
	...
	table.sort(self.m_tDataList, function (a,b)
		-- body
		local tData1 = GDatatab_home_building["id_"..a.configId]
		local tData2 = GDatatab_home_building["id_"..b.configId]
		if tData1.type ~= tData2.type then 
			return tData1.type < tData2.type
		else
			return tData1.sort < tData2.sort
		end
	end)
	self:_update()
end
