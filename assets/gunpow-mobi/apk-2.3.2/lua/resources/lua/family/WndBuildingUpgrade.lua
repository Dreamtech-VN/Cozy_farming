...
function WndBuildingUpgrade:_showDifferentProperty(tData, tNextData)
    -- body
    local sFormat = [[<T C="255,255,255" S="18" P="1" SC="132,66,29" SE="1" SS="4">%s</T><T C="255,255,255" S="18" P="1" SC="132,66,29" SE="1" SS="4">%s</T>]]
...
function WndBuildingUpgrade:_setBtnState(tData)
    ...
    local sCostFormat = [[<T S="18" C="127,70,26" P="1">%s</T><I Z="0.45" P="1">%s</I><T S="18" C="127,70,26" P="1">%d</T>]]
    ...
    if txtTime then 
        ...
        local nHour = math.floor((tData.basicData.upgrade_time - nDay * 24 * 3600)/3600)
...
function WndBuildingUpgrade:_adaptLanguage_ug(  )
    GetElement(self.m_root,"txtBtnUpgrade1_WndBuildingUpgrade",WZUILabelTTF):setScale(0.8)
    GetElement(self.m_root,"txtBtnUpgrade2_WndBuildingUpgrade",WZUILabelTTF):setScale(0.8)

    GetElement(self.m_root, "txtCondition_WndBuildingUpgrade", WZUILabelTTF):setScale(0.8)
