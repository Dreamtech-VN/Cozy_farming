...
function CellFootballShootRank:onLoadData(element)
	...
	local headNode,headLua = CellHead:show(conHead,v[5],v[4],v[6],nil,GlobalMethod:ccp(0.52,0.3),v[8],v[9],nil,nil,0.75)
...
function CellFootballShootRank:_footballReward(  )
	--GetElement(conRankListReward,"imgRewardLine_CellFootballShootRank",WZUIImage):setFile("ui/common/football_pattern_002.png")
