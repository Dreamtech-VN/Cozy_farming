...
function WndFootballAct:_adaptLanguage_vn(  )
	...
	GetElement(self.m_root,"txtRecoeds1_WndFootballAct",WZUILabelTTF):setScale(0.65)
	GetElement(self.m_root,"txtRecoeds2_WndFootballAct",WZUILabelTTF):setScale(0.65)
	GetElement(self.m_root,"txtRecoeds3_WndFootballAct",WZUILabelTTF):setScale(0.65)
