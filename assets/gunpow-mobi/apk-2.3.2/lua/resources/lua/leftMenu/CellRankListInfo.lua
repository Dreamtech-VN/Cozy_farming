...
--@param    人物性别
--@param    添加到容器的名称
function CellRankListInfo:_showHeadIcon(faceId, headId, sex, sConName,vipLevel, headColor, headEffectId)
