...
function WndStarSoul:activityOKSpine()
    ...
    local spinePath = "ui/otherUI/ui_xinghun_jhcg"
    ...
    if existSpine then 
        ...
        local _sIndex = "ui_xinghun_jhcg"
        local downloadInfo = GetDownloadInfo(_sIndex, "uiEffect")
        if downloadInfo then 
            DownloadManager:addDownloadTask(14207,downloadInfo.url,downloadInfo.md5,_sIndex,"DownloadResourceCallback", _G)
        end
    end
