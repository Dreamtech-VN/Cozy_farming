...
--@brief 	设置新底图
function CellWeChat:setNewBg()
	-- body
	GetElement(self.m_root, "imgNor_CellWeChat", WZUIImage):setFile("ui/shop/common_btn_shop.png")
	GetElement(self.m_root, "imgSel_CellWeChat", WZUIImage):setFile("ui/shop/common_btn_shop.png")
	local txtBtn = GetElement(self.m_root, "txtBtn_CellWeChat", WZUILabelTTF)
	if txtBtn then 
		txtBtn:setLabelStyleKey("")
		txtBtn:setScale(0.8)
	end
end
-------------------------------------公有方法模块End----------------------------------------
