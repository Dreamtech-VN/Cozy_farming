...
function UpdateNetwork(dt)
    ...
    --     end
    -- end    
    if GMEVoiceBridge ~= nil and GMEVoiceBridge.GetVoiceEngine ~= nil and GMEVoiceBridge:GetVoiceEngine() and WGMEVoiceNotify:IsSupportVoice() and GMEVoiceBridge.poll then 
        --WZLog("UpdateNetwork NetManager:GMETest")
        local ret = GMEVoiceBridge:poll()
        -- if ret ~= 0 then 
        --     --WZLog("GMEVoiceBridge:GetVoiceEngine():Poll() failed",ret)
        -- end
    end
