...
function WndBuyFiveAttention:_adaptLanguage_ug(  )
    GetElement(self.m_root,"imgArrow1_WndBuyFiveAttention",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.2,0.85))
    GetElement(self.m_root,"imgArrow2_WndBuyFiveAttention",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.8,0.85))

    GetElement(self.m_root, "txtConfirm_WndBuyFiveAttention", WZUILabelTTF):setScale(0.6)

    local txtCostWord = GetElement(self.m_root,"txtCostWord_WndBuyFiveAttention",WZUILabelTTF)
    txtCostWord:setScale(0.7)
    txtCostWord:setDimensions(GlobalMethod:CCSize(200))
    local imgCostIcon = GetElement(self.m_root,"imgCostIcon_WndBuyFiveAttention",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.64,0.5))
    GetElement(self.m_root,"txtCostNum_WndBuyFiveAttention",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.72,0.5))
    local txtGetWord = GetElement(self.m_root,"txtGetWord_WndBuyFiveAttention",WZUILabelTTF)
    txtGetWord:setScale(0.7)
    txtGetWord:setDimensions(GlobalMethod:CCSize(200))
    local imgGaainIcon = GetElement(self.m_root,"imgGaainIcon_WndBuyFiveAttention",WZUIImage):setRelativePosition(GlobalMethod:ccp(0.64,0.27))
    GetElement(self.m_root,"txtGetNum_WndBuyFiveAttention",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.72,0.27))

    GetElement(self.m_root, "txtConForAtt_WndBuyFiveAttention", WZUILabelTTF):setScale(0.5)
end
-------------------------------------私有方法模块End----------------------------------------
