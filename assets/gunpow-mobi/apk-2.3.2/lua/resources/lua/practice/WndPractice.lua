...
function WndPractice:_initMove()
	...
	for i=1, 3 do
		...
		if result == 7 then
			...
			if expNum == 3 then
				--boom
				local spinePath = "ui/otherUI/ui_xiulian_super"
...
function WndPractice:_addExpSchedule(element)
	local tag = element:getTag()
	if not self.t_data.addExp then return end
...
function WndPractice:_createSpine(element, posX, posY, action)
	...
	local spinePath = "ui/otherUI/ui_xiulian"
	local existSpine = CheckEffectFile(spinePath)
	if existSpine then 
		local spine = WZUISpine:create()
		spine:setFileAtlas(spinePath .. ".atlas")
		...
		if posX ~= nil and posY ~= nil then
			spine:setPosition(GlobalMethod:ccp(posX,posY+10))
		end
	else
		self:_upgradeOver()
	end
...
function WndPractice:_adaptLanguage_vn(  )
	...
	GetElement(self.m_root,"value4",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.72,-1.7))
	GetElement(self.m_root,"value5",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.72,-1.7))
	GetElement(self.m_root,"value6",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.72,-1.7))
end
...
function WndPractice:_adaptLanguage_es(  )
	...
	local txtInvite = GetElement(self.m_root,"txtInvite_WndPractice",WZUILabelTTF)
	txtInvite:setDimensions(GlobalMethod:CCSize(240))
	txtInvite:setRelativePosition(GlobalMethod:ccp(0.5,-0.35))
end

function WndPractice:_adaptLanguage_ug(  )
	local btnText1 = GetElement(self.m_root,"btnText1",WZUILabelTTF)
	btnText1:setScale(0.7)
	btnText1:setDimensions(GlobalMethod:CCSize(160))
	local btnText2 = GetElement(self.m_root,"btnText2",WZUILabelTTF)
	btnText2:setScale(0.7)
	btnText2:setDimensions(GlobalMethod:CCSize(160))

	local txtItemName1 = GetElement(self.m_root,"txtItemName1_WndPractice",WZUILabelTTF)
	txtItemName1:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName1:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local txtItemName2 = GetElement(self.m_root,"txtItemName2_WndPractice",WZUILabelTTF)
	txtItemName2:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName2:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local txtItemName3 = GetElement(self.m_root,"txtItemName3_WndPractice",WZUILabelTTF)
	txtItemName3:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName3:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local txtItemName4 = GetElement(self.m_root,"txtItemName4_WndPractice",WZUILabelTTF)
	txtItemName4:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName4:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local txtItemName5 = GetElement(self.m_root,"txtItemName5_WndPractice",WZUILabelTTF)
	txtItemName5:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName5:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local txtItemName6 = GetElement(self.m_root,"txtItemName6_WndPractice",WZUILabelTTF)
	txtItemName6:setAnchorPoint(GlobalMethod:ccp(1,0.5))
	txtItemName6:setRelativePosition(GlobalMethod:ccp(1.3,-2))
	local value1 = GetElement(self.m_root,"value1",WZUILabelTTF)
	value1:setRelativePosition(GlobalMethod:ccp(-0.3,-2))
	local value2 = GetElement(self.m_root,"value2",WZUILabelTTF)
	value2:setRelativePosition(GlobalMethod:ccp(-0.3,-2))
	local value3 = GetElement(self.m_root,"value3",WZUILabelTTF)
	value3:setRelativePosition(GlobalMethod:ccp(-0.3,-2))
	local value4 = GetElement(self.m_root,"value4",WZUILabelTTF)
	value4:setRelativePosition(GlobalMethod:ccp(-0.3,-2))
	local value5 = GetElement(self.m_root,"value5",WZUILabelTTF)
	value5:setRelativePosition(GlobalMethod:ccp(-0.3,-2))
	local value6 = GetElement(self.m_root,"value6",WZUILabelTTF)
	value6:setRelativePosition(GlobalMethod:ccp(-0.3,-2))

	local txtDoubleCost2 = GetElement(self.m_root,"txtDoubleCost2",WZUILabelTTF)
	txtDoubleCost2:setScale(0.7)
	txtDoubleCost2:setDimensions(GlobalMethod:CCSize(120))
	GetElement(self.m_root,"freeText2_WndPractice",WZUIFreeTextBox):setScale(0.7)

	GetElement(self.m_root,"txtRemaining_WndPractice",WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(1.04,0.5))
	GetElement(self.m_root,"conRemaining_WndPractice",WZUIContainer):setRelativePosition(GlobalMethod:ccp(0.41,0.5))
end
-------------------------------------语言适配End----------------------------------------
