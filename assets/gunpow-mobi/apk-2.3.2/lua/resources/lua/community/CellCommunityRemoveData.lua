...
function CellCommunityRemove:_init()
	...
	self.m_nWeekDonate = nil 
	self.m_nAllDonate = nil 
...
function CellCommunityRemove:createElement()
    ...
    element:setAbsContentSize(GlobalMethod:CCSize(660,100))   --这个容器的大小要和cell的大小一致
...
--@param #7 sState 状态
function CellCommunityRemove:setData(tData, nWinType)										
	...
	self.m_nWeekDonate = tData.weekDonate
	self.m_nAllDonate = tData.allDonate
	self.m_nHeadEffectId = tData.headEffectId
