...
function CellCommunityCheckDonate:onLoadData(element)
	...
	--战力
	GetElement(self.m_root, "lafFight_CellCommunityCheckDonate", WZUILabelAtlasFont):setText(tData.fight)
	GetElement(self.m_root, "txtFighting_CellCommunityCheckDonate", WZUILabelTTF):setText(LocalStrings.COMBAT .. ": ")

	GetElement(self.m_root, "txtWeekWord_CellCommunityCheckDonate", WZUILabelTTF):setText(LocalStrings.COMMUNITYINFO106 .. ": ")
	GetElement(self.m_root, "txtLastWord_CellCommunityCheckDonate", WZUILabelTTF):setText(LocalStrings.COMMUNITYINFO107 .. ": ")
	GetElement(self.m_root, "txtAllWord_CellCommunityCheckDonate", WZUILabelTTF):setText(LocalStrings.COMMUNITYINFO105 .. ": ")
	--贡献
	GetElement(self.m_root,"ttfWeekDonate_CellCommunityCheckDonate",WZUILabelTTF):setText(tData.weekDonate)
	GetElement(self.m_root,"ttfLastDonate_CellCommunityCheckDonate",WZUILabelTTF):setText(tData.lastDonate)
	GetElement(self.m_root,"ttfAllDonate_CellCommunityCheckDonate",WZUILabelTTF):setText(tData.allDonate)
	--登陆时间
	local NTIME = 60
