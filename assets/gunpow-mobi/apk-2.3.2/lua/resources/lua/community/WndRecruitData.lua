...
--@brief 	外部接口
function WndRecruit:showInterface(nWinType)
...
--@param #5 sex : 性别
function WndRecruit:SendApprovingMemberList(id, name, level, vipLevel, headId, faceId, sex, fight, headColor, headEffectId)
	WZLog("WndRecruit:SendApprovingMemberList", Serialize(level))
	self.m_tPendProList = {}
	for i=1,#id do
		local tempList = {}
