...
function CellCommunityList:_update()
	...
	--排名前三显示图片
	local picName = {"ui/common/common_icon_1st_1.png","ui/common/common_icon_2nd_1.png","ui/common/common_icon_3rd_1.png"}
	...
	if txtCommunityName ~= nil then 
		...
		if txtCommunityName ~= nil and self.m_sLevel ~= nil and self.m_sName ~= nil then 
			local formatStr = [[<T C="127,70,26" S="20" P="1">%s</T><T C="229,105,22" S="20" P="1">%d  </T><T C="127,70,26" S="20" P="1">%s</T>]]
			txtCommunityName:setShowText(string.format(formatStr, LocalStrings.LV, self.m_sLevel, self.m_sName))
		end 
	end 
...
function CellCommunityList:setGreen()
	GetElement(self.m_root, "imgBtn1_CellCommunityList", WZUI9Image):setFile("ui/common/frame_lieb_01.png")
	GetElement(self.m_root, "imgBtn2_CellCommunityList", WZUI9Image):setFile("ui/common/frame_lieb_01.png")
	GetElement(self.m_root, "imgBtn3_CellCommunityList", WZUI9Image):setFile("ui/common/frame_lieb_01.png")
end
...
function CellCommunityList:setElementPosition(inCommunity)
	...
	if inCommunity == true then
		...
		GetElement(self.m_root, "txtCommunityName_CellCommunityList", WZUIFreeTextBox):setRelativePosition(GlobalMethod:ccp(0.32,0.7))
		...
		GetElement(self.m_root, "txtCommunityName_CellCommunityList", WZUIFreeTextBox):setRelativePosition(GlobalMethod:ccp(0.292,0.7))
