...
function CellCommunityBossWarRank:setRank(tData)
	...
	if not tData.isFirst and self.m_tData.guildId == CacheCenter:getPlayerInfo().guildId then
		GetElement(self.m_root,"imgBg_CellCommunityBossWarRank",WZUI9Image):setFile("ui/common/frame_lieb_01.png")
	else
		GetElement(self.m_root,"imgBg_CellCommunityBossWarRank",WZUI9Image):setFile("ui/common/frame_lieb.png")
	end
