...
-------------------------------------语言适配begin--------------------------------------
function CellCompeteTask_adaptLanguage_ug( )
    GetElement(self.m_root, "label_name", WZUILabelTTF):setDimensions(GlobalMethod:CCSize(140))
    GetElement(self.m_root, "label_param", WZUILabelTTF):setRelativePosition(GlobalMethod:ccp(0.5,0.15))
end
