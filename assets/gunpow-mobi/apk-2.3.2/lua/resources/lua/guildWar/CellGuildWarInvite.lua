...
function CellGuildWarInvite:_update()
    ...
    GetElement(self.m_root,"labLv_CellGuildWarInvite",WZUILabelTTF):setText(data.level)
    GetElement(self.m_root,"labName_CellGuildWarInvite",WZUILabelTTF):setText(data.name)
    GetElement(self.m_root,"labFight_CellGuildWarInvite",WZUILabelTTF):setText(data.fighting)
