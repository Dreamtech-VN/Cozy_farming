...
function SceneCommunityWar:_setDynamicText()
    ...
    WZLog("aaaaaaaaaaaaaaaaaaaaaa",ftxtGroupTitle)
    ...
    if self.m_nBottomIndex == 1 then
        ...
        --出线榜我的公会排名
        local sNoInListFormat = [[<T C="127,70,26" S="20" P="1">%s:</T><T C="127,70,26" S="20" P="1">%s</T>]]
...
function SceneCommunityWar:_showLeftTime()
    ...
    local sTimeFormat = [[<T C="127,70,26" S="20" P="1">%s</T><T C="255,89,74" S="20" P="1"> %s</T>]]
    local sTimeFormat1 = [[<T C="255,89,74" S="20" P="1">%s</T><T C="127,70,26" S="20" P="1"> %s</T>]]
...
function SceneCommunityWar:_adaptLanguage_ug(  )
    local txtCheck1 = GetElement(self.m_root,"txtCheck1_SceneCommunityWar",WZUILabelTTF)
    txtCheck1:setScale(0.7)
    txtCheck1:setDimensions(GlobalMethod:CCSize(100))
    local txtCheck2 = GetElement(self.m_root,"txtCheck2_SceneCommunityWar",WZUILabelTTF)
    txtCheck2:setScale(0.7)
    txtCheck2:setDimensions(GlobalMethod:CCSize(100))
    local txtCheck3 = GetElement(self.m_root,"txtCheck3_SceneCommunityWar",WZUILabelTTF)
    txtCheck3:setScale(0.7)
    txtCheck3:setDimensions(GlobalMethod:CCSize(100))
    local txtCheck4 = GetElement(self.m_root,"txtCheck4_SceneCommunityWar",WZUILabelTTF)
    txtCheck4:setScale(0.7)
    txtCheck4:setDimensions(GlobalMethod:CCSize(100))

    local txtLeft = GetElement(self.m_root,"txtLeftGroup_SceneCommunityWar",WZUILabelTTF)
    txtLeft:setScale(0.6)
    txtLeft:setDimensions(GlobalMethod:CCSize(110,0))

    local ftxtGroupTitle = GetElement(self.m_root, "ftxtGroupTitle_SceneCommunityWar", WZUIFreeTextBox)
    ftxtGroupTitle:setScale(0.7)
    ftxtGroupTitle:setMaxWidth(800)
