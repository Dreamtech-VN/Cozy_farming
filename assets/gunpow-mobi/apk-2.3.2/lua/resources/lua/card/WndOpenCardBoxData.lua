...
function WndOpenCardBox:_init()
    ...
    self.m_nMaxCdTime = 0               --允许最大的CD时间
    self.m_bacth = nil
    self.m_maxNum = nil             --开启卡包数量
    self.m_tag = nil
end
...
function WndOpenCardBox:createElement()
    if WndOpenCardBox.m_root ~= nil then
        WindowManager:removeWindow(WndOpenCardBox.m_root, WndOpenCardBox, true)
    end
