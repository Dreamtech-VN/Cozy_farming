...
--@brief 	设置排名数据
function WndMonthFighting:setRankListData(ranking, playerId, name, faceId, headId, sex, level, param1, param2, param3, param4, param5, param6, param7, rankType, trendRank, vipLevel, param8, headColor, param9, headEffectId, qqHallInfo)
	-- body
	self:_stopLoading()
