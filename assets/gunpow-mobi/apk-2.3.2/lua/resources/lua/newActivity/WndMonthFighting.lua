...
function WndMonthFighting:setCheckBoxAndCon(tag)
    ...
    if self.activityId == g_tGameActivityTypes.ACTIVITY_FLOWER_LIST then
        GetElement(self.m_root,"checkBox3_WndMonthFighting",WZUICheckBox):setVisible(true)
    end
    for i = 1, 3 do
...
function WndMonthFighting:createMatchRank1()
    ...
    for i = 1, #self.m_tRankList do
        ...
        --初始化cell
        if self.activityId == g_tGameActivityTypes.ACIVIITY_RECHARGERANK then
            tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 38, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
        elseif self.activityId == g_tGameActivityTypes.ACIVIITY_CROSS_RECHARGERANK then
            tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 39, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
        elseif self.activityId == g_tGameActivityTypes.ACIVIITY_CONSUMERANK then
            tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 40, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
        elseif self.activityId == g_tGameActivityTypes.ACIVIITY_CROSS_CONSUMERANK then
            tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 41, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
        elseif self.activityId == g_tGameActivityTypes.ACTIVITY_FLOWER_LIST then
            if self.nFlowerSex == 0 or self.nFlowerSex == nil then
                tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 46, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
            elseif self.nFlowerSex == 1 then
                tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 47, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
            end
        else
            tCell:setData(t.ranking, t.playerId, t.name, t.faceId, t.headId, t.sex, t.level, t.param1, t.param2, t.param3, t.param4, t.param5, t.param6, t.param7, 1, t.trendRank, t.vipLevel, t.param8, t.headColor, t.param9, t.headEffectId, t.wifeHeadEffectId, t.qqHallData)
        end
    end
...
function WndMonthFighting:createMatchRank3()
    ...
    if not self.tabFlowerRecord then return end
    
    local ftxtMyRank = GetElement(self.m_root,"ftxtMyRank_WndMonthFighting",WZUIFreeTextBox)
    local ftxtEndTime = GetElement(self.m_root,"ftxtEndTime_WndMonthFighting",WZUIFreeTextBox)

    ftxtMyRank:setVisible(false)
    ftxtEndTime:setVisible(false)

    local tabFlower = GetElement(self.m_root,"tabFlower_WndMonthFighting",WZUITableContainer)
    tabFlower:cleanTable()
    local conList = GetElement(self.m_root, "conList_WndMonthFighting", WZUIContainer)
    if self.tabFlowerRecord and #self.tabFlowerRecord.playerData == 0 then 
        ShowPanelNullTip( conList, LocalStrings.CHARM_RESULT)
        return 
    end
    removeShowPanelNullTip(conList)
...
-------------------------------------语言适配Begin----------------------------------------
function WndMonthFighting:_adaptLanguage_ug()
