...
function CellSpecifyPanel:onClickBuy(element)
    ...
    if self.m_nGiftType == 1 then 
        ...
        WZLog("CellSpecifyPanel:onClickBuy:",self.m_ItemId)
...
function CellSpecifyPanel:_updateLeftTimes()
    ...
    local sFormat = [[<T C="127,70,26" S="18" P="1">%s</T><T C="229,105,22" S="18" P="1">%d</T><T C="127,70,26" S="18" P="1">%s</T>]]
    if ftxtLeftNum then 
        if self.m_nLeftCount == -1 then 
            sFormat = [[<T C="127,70,26" S="18" P="1">%s</T>]]
...
function CellSpecifyPanel:_adaptLanguage_ug(  )
    GetElement(self.m_root,"txtBuy_CellSpecifyPanel",WZUILabelTTF):setScale(0.7)
    GetElement(self.m_root,"txtT_CellSpecifyPanel",WZUILabelTTF):setScale(0.7)

end

function CellSpecifyPanel:_adaptLanguage_vn(  )
    GetElement(self.m_root,"txtBuy_CellSpecifyPanel",WZUILabelTTF):setScale(0.7)
end
